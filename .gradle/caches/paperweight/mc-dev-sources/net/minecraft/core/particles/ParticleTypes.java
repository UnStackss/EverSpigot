...
public class ParticleTypes {
    ...
    public static final ParticleType<DustParticleOptions> DUST = register(
        "dust", false, type -> DustParticleOptions.CODEC, type -> DustParticleOptions.STREAM_CODEC
    );
    public static final ParticleType<DustColorTransitionOptions> DUST_COLOR_TRANSITION = register(
        "dust_color_transition", false, type -> DustColorTransitionOptions.CODEC, type -> DustColorTransitionOptions.STREAM_CODEC
    );
    ...
    public static final ParticleType<SculkChargeParticleOptions> SCULK_CHARGE = register(
        "sculk_charge", true, type -> SculkChargeParticleOptions.CODEC, type -> SculkChargeParticleOptions.STREAM_CODEC
    );
    ...
    public static final ParticleType<VibrationParticleOption> VIBRATION = register(
        "vibration", true, type -> VibrationParticleOption.CODEC, type -> VibrationParticleOption.STREAM_CODEC
    );
    ...
    public static final ParticleType<ShriekParticleOption> SHRIEK = register(
        "shriek", false, type -> ShriekParticleOption.CODEC, type -> ShriekParticleOption.STREAM_CODEC
    );
    ...
    private static <T extends ParticleOptions> ParticleType<T> register(
        ...
        return Registry.register(BuiltInRegistries.PARTICLE_TYPE, name, new ParticleType<T>(alwaysShow) {
            @Override
