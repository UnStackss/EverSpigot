...
public record GameTypePredicate(List<GameType> types) {
    ...
    public static GameTypePredicate of(GameType... gameModes) {
        return new GameTypePredicate(Arrays.stream(gameModes).toList());
    }

    public boolean matches(GameType gameMode) {
