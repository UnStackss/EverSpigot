...
public class AvoidEntityGoal<T extends LivingEntity> extends Goal {
    ...
    public AvoidEntityGoal(PathfinderMob mob, Class<T> fleeFromType, float distance, double slowSpeed, double fastSpeed) {
        this(mob, fleeFromType, livingEntity -> true, distance, slowSpeed, fastSpeed, EntitySelector.NO_CREATIVE_OR_SPECTATOR::test);
    }
        ...
        this.toAvoid = this.mob
            ...
            .getNearestEntity(
                this.mob
                    .level()
                    .getEntitiesOfClass(
                        this.avoidClass, this.mob.getBoundingBox().inflate((double)this.maxDist, 3.0, (double)this.maxDist), livingEntity -> true
                    ),
