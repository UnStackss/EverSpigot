...
public record CatVariant(ResourceLocation texture) {
    ...
    private static ResourceKey<CatVariant> createKey(String id) {
        return ResourceKey.create(Registries.CAT_VARIANT, ResourceLocation.withDefaultNamespace(id));
    }
    ...
    private static CatVariant register(Registry<CatVariant> registry, ResourceKey<CatVariant> key, String textureId) {
        return Registry.register(registry, key, new CatVariant(ResourceLocation.withDefaultNamespace(textureId)));
    }
}
