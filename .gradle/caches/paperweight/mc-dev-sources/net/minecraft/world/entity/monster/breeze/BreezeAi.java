...
public class BreezeAi {
    ...
    private static void initFightActivity(Breeze breeze, Brain<Breeze> brain) {
        brain.addActivityWithConditions(
            Activity.FIGHT,
            ImmutableList.of(
                Pair.of(0, StopAttackingIfTargetInvalid.create(livingEntity -> !Sensor.isEntityAttackable(breeze, livingEntity))),
                Pair.of(1, new Shoot()),
    ...
    public static class SlideToTargetSink extends MoveToTargetSink {
        @VisibleForTesting
        public SlideToTargetSink(int minRunTime, int maxRunTime) {
