...
public class HoverRandomPos {
    ...
    public static Vec3 getPos(
        PathfinderMob entity, int horizontalRange, int verticalRange, double x, double z, float angle, int maxAboveSolid, int minAboveSolid
    ) {
                ...
                if (blockPos == null) {
                    ...
                    if (blockPos2 == null) {
                        ...
                        blockPos2 = RandomPos.moveUpToAboveSolid(
                            ...
                            pos -> GoalUtils.isSolid(entity, pos)
                        );
