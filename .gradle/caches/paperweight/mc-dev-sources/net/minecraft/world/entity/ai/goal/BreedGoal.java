...
public class BreedGoal extends Goal {
    ...
    public BreedGoal(Animal animal, double speed) {
        this(animal, speed, (Class<? extends Animal>)animal.getClass());
    }

    public BreedGoal(Animal animal, double speed, Class<? extends Animal> entityClass) {
        this.animal = animal;
