...
public class AdultSensor extends Sensor<AgeableMob> {
    ...
    private void setNearestVisibleAdult(AgeableMob entity, NearestVisibleLivingEntities livingTarget) {
        Optional<AgeableMob> optional = livingTarget.findClosest(livingEntity -> livingEntity.getType() == entity.getType() && !livingEntity.isBaby())
