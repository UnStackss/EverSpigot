...
public class PolarBear extends Animal implements NeutralMob {
    ...
    public static boolean checkPolarBearSpawnRules(EntityType<PolarBear> type, LevelAccessor world, MobSpawnType spawnReason, BlockPos pos, RandomSource random) {
        ...
        return !holder.is(BiomeTags.POLAR_BEARS_SPAWN_ON_ALTERNATE_BLOCKS)
            ? checkAnimalSpawnRules(type, world, spawnReason, pos, random)
            : isBrightEnoughToSpawn(world, pos) && world.getBlockState(pos.below()).is(BlockTags.POLAR_BEARS_SPAWNABLE_ON_ALTERNATE);
    }
