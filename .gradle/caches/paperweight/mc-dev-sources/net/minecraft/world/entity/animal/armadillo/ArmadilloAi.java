...
public class ArmadilloAi {
    ...
    private static final OneShot<Armadillo> ARMADILLO_ROLLING_OUT = BehaviorBuilder.create(
        context -> context.group(context.absent(MemoryModuleType.DANGER_DETECTED_RECENTLY)).apply(context, memoryAccessor -> (serverLevel, armadillo, l) -> {
            ...
            ImmutableList.of(
                ...
                new MoveToTargetSink() {
                    ...
                    protected boolean checkExtraStartConditions(ServerLevel world, Mob entity) {
                        if (entity instanceof Armadillo armadillo && armadillo.isScared()) {
                            return false;
                        }
    ...
    public static class ArmadilloBallUp extends Behavior<Armadillo> {
        ...
        @Override
        protected boolean checkExtraStartConditions(ServerLevel world, Armadillo entity) {
