...
public record FrogVariant(ResourceLocation texture) {
    ...
    private static ResourceKey<FrogVariant> createKey(String id) {
        return ResourceKey.create(Registries.FROG_VARIANT, ResourceLocation.withDefaultNamespace(id));
    }
    ...
    private static FrogVariant register(Registry<FrogVariant> registry, ResourceKey<FrogVariant> key, String id) {
        return Registry.register(registry, key, new FrogVariant(ResourceLocation.withDefaultNamespace(id)));
    }
}
