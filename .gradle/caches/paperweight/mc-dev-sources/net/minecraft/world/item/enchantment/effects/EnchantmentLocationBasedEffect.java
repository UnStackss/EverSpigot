...
public interface EnchantmentLocationBasedEffect {
    ...
    void onChangedBlock(ServerLevel world, int level, EnchantedItemInUse context, Entity user, Vec3 pos, boolean newlyApplied);

    default void onDeactivated(EnchantedItemInUse context, Entity user, Vec3 pos, int level) {
    }
