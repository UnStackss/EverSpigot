...
public record MapDecorations(Map<String, MapDecorations.Entry> decorations) {
    ...
    public MapDecorations withDecoration(String id, MapDecorations.Entry decoration) {
        return new MapDecorations(Util.copyAndPut(this.decorations, id, decoration));
    }
