...
public record WritableBookContent(@Override List<Filterable<String>> pages) implements BookContent<String, WritableBookContent> {
    ...
    public static final Codec<WritableBookContent> CODEC = RecordCodecBuilder.create(
        instance -> instance.group(PAGES_CODEC.optionalFieldOf("pages", List.of()).forGetter(WritableBookContent::pages))
    ...
    public Stream<String> getPages(boolean shouldFilter) {
