...
public class SmithingTemplateItem extends Item {
    ...
    public SmithingTemplateItem(
        ...
        this.appliesTo = appliesToText;
        this.ingredients = ingredientsText;
        this.upgradeDescription = titleText;
        this.baseSlotDescription = baseSlotDescriptionText;
        this.additionsSlotDescription = additionsSlotDescriptionText;
        this.baseSlotEmptyIcons = emptyBaseSlotTextures;
        this.additionalSlotEmptyIcons = emptyAdditionsSlotTextures;
    }

    public static SmithingTemplateItem createArmorTrimTemplate(ResourceKey<TrimPattern> trimPattern, FeatureFlag... requiredFeatures) {
        return createArmorTrimTemplate(trimPattern.location(), requiredFeatures);
    }

    public static SmithingTemplateItem createArmorTrimTemplate(ResourceLocation trimPatternIn, FeatureFlag... requiredFeatures) {
        return new SmithingTemplateItem(
            ARMOR_TRIM_APPLIES_TO,
            ARMOR_TRIM_INGREDIENTS,
            Component.translatable(Util.makeDescriptionId("trim_pattern", trimPatternIn)).withStyle(TITLE_FORMAT),
