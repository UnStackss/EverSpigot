...
public interface EnchantmentEntityEffect extends EnchantmentLocationBasedEffect {
    ...
    void apply(ServerLevel world, int level, EnchantedItemInUse context, Entity user, Vec3 pos);

    @Override
    default void onChangedBlock(ServerLevel world, int level, EnchantedItemInUse context, Entity user, Vec3 pos, boolean newlyApplied) {
