...
public record ArmorMaterial(
    ...
    public static final class Layer {
        ...
        public Layer(ResourceLocation id, String suffix, boolean dyeable) {
            this.assetName = id;
            this.suffix = suffix;
        ...
        private ResourceLocation resolveTexture(boolean secondLayer) {
            return this.assetName
                .withPath(path -> "textures/models/armor/" + this.assetName.getPath() + "_layer_" + (secondLayer ? 2 : 1) + this.suffix + ".png");
        }

        public ResourceLocation texture(boolean secondLayer) {
            return secondLayer ? this.innerTexture : this.outerTexture;
        }
