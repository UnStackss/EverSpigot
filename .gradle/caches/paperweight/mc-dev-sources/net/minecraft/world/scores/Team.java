...
public abstract class Team {
    ...
    public static enum CollisionRule {
        ...
        private static final Map<String, Team.CollisionRule> BY_NAME = Arrays.stream(values())
            .collect(Collectors.toMap(collisionRule -> collisionRule.name, collisionRule -> (Team.CollisionRule)collisionRule));
    ...
    public static enum Visibility {
        ...
        private static final Map<String, Team.Visibility> BY_NAME = Arrays.stream(values())
            .collect(Collectors.toMap(visibilityRule -> visibilityRule.name, visibility -> (Team.Visibility)visibility));
        public final String name;
        public final int id;
        ...
        private Visibility(final String name, final int value) {
            this.name = name;
            this.id = value;
        }
