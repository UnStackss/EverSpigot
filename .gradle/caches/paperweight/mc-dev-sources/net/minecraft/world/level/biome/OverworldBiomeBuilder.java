...
public final class OverworldBiomeBuilder {
    ...
    public static String getDebugStringForPeaksAndValleys(double weirdness) {
        if (weirdness < (double)NoiseRouterData.peaksAndValleys(0.05F)) {
            return "Valley";
        } else if (weirdness < (double)NoiseRouterData.peaksAndValleys(0.26666668F)) {
            return "Low";
        } else if (weirdness < (double)NoiseRouterData.peaksAndValleys(0.4F)) {
            return "Mid";
        } else {
            return weirdness < (double)NoiseRouterData.peaksAndValleys(0.56666666F) ? "High" : "Peak";
        }
    }
