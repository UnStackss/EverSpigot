...
public class LevelSummary implements Comparable<LevelSummary> {
    ...
    public LevelSummary(
        LevelSettings levelInfo, LevelVersion versionInfo, String name, boolean requiresConversion, boolean locked, boolean experimental, Path iconPath
    ) {
    ...
    public static enum BackupStatus {
        ...
        private BackupStatus(final boolean backup, final boolean dangerous, final String translationKeySuffix) {
            this.shouldBackup = backup;
            this.severe = dangerous;
    ...
    public static class CorruptedLevelSummary extends LevelSummary {
        ...
        public CorruptedLevelSummary(String name, Path iconPath, long lastPlayed) {
