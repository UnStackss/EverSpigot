...
public record BannerPatternLayers(List<BannerPatternLayers.Layer> layers) {
    ...
    public static class Builder {
        ...
        @Deprecated
        public BannerPatternLayers.Builder addIfRegistered(HolderGetter<BannerPattern> patternLookup, ResourceKey<BannerPattern> pattern, DyeColor color) {
            Optional<Holder.Reference<BannerPattern>> optional = patternLookup.get(pattern);
            if (optional.isEmpty()) {
                BannerPatternLayers.LOGGER.warn("Unable to find banner pattern with id: '{}'", pattern.location());
                return this;
            } else {
        ...
        public BannerPatternLayers.Builder addAll(BannerPatternLayers patterns) {
