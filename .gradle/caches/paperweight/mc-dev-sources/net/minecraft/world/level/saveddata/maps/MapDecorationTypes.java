...
public class MapDecorationTypes {
    ...
    private static Holder<MapDecorationType> register(String id, String assetId, boolean showOnItemFrame, boolean trackCount) {
    ...
    private static Holder<MapDecorationType> register(
        ...
        ResourceKey<MapDecorationType> resourceKey = ResourceKey.create(Registries.MAP_DECORATION_TYPE, ResourceLocation.withDefaultNamespace(id));
        MapDecorationType mapDecorationType = new MapDecorationType(
            ResourceLocation.withDefaultNamespace(assetId), showOnItemFrame, mapColor, explorationMapElement, trackCount
        );
