...
public class OceanMonumentPieces {
    ...
    static class FitDoubleXRoom implements OceanMonumentPieces.MonumentRoomFitter {
        ...
        @Override
        public OceanMonumentPieces.OceanMonumentPiece create(Direction direction, OceanMonumentPieces.RoomDefinition setting, RandomSource random) {
    ...
    static class FitDoubleXYRoom implements OceanMonumentPieces.MonumentRoomFitter {
        @Override
        public boolean fits(OceanMonumentPieces.RoomDefinition setting) {
            if (setting.hasOpening[Direction.EAST.get3DDataValue()]
                && !setting.connections[Direction.EAST.get3DDataValue()].claimed
                && setting.hasOpening[Direction.UP.get3DDataValue()]
                && !setting.connections[Direction.UP.get3DDataValue()].claimed) {
    ...
    static class FitDoubleYZRoom implements OceanMonumentPieces.MonumentRoomFitter {
        @Override
        public boolean fits(OceanMonumentPieces.RoomDefinition setting) {
            if (setting.hasOpening[Direction.NORTH.get3DDataValue()]
                && !setting.connections[Direction.NORTH.get3DDataValue()].claimed
                && setting.hasOpening[Direction.UP.get3DDataValue()]
                && !setting.connections[Direction.UP.get3DDataValue()].claimed) {
    ...
    static class FitSimpleTopRoom implements OceanMonumentPieces.MonumentRoomFitter {
        @Override
        public boolean fits(OceanMonumentPieces.RoomDefinition setting) {
            return !setting.hasOpening[Direction.WEST.get3DDataValue()]
                && !setting.hasOpening[Direction.EAST.get3DDataValue()]
                && !setting.hasOpening[Direction.NORTH.get3DDataValue()]
                && !setting.hasOpening[Direction.SOUTH.get3DDataValue()]
                && !setting.hasOpening[Direction.UP.get3DDataValue()];
        }
    ...
    public static class MonumentBuilding extends OceanMonumentPieces.OceanMonumentPiece {
        ...
        public void postProcess(
            ...
            for (OceanMonumentPieces.OceanMonumentPiece oceanMonumentPiece : this.childPieces) {
                if (oceanMonumentPiece.getBoundingBox().intersects(chunkBox)) {
                    oceanMonumentPiece.postProcess(world, structureAccessor, chunkGenerator, random, chunkBox, chunkPos, pivot);
                }
            }
        }

        private void generateWing(boolean side, int start, WorldGenLevel world, RandomSource random, BoundingBox box) {
            int i = 24;
            if (this.chunkIntersects(box, start, 0, start + 23, 20)) {
                this.generateBox(world, box, start + 0, 0, 0, start + 24, 0, 20, BASE_GRAY, BASE_GRAY, false);
                this.generateWaterBox(world, box, start + 0, 1, 0, start + 24, 10, 20);

                for (int j = 0; j < 4; j++) {
                    this.generateBox(world, box, start + j, j + 1, j, start + j, j + 1, 20, BASE_LIGHT, BASE_LIGHT, false);
                    this.generateBox(world, box, start + j + 7, j + 5, j + 7, start + j + 7, j + 5, 20, BASE_LIGHT, BASE_LIGHT, false);
                    this.generateBox(world, box, start + 17 - j, j + 5, j + 7, start + 17 - j, j + 5, 20, BASE_LIGHT, BASE_LIGHT, false);
                    this.generateBox(world, box, start + 24 - j, j + 1, j, start + 24 - j, j + 1, 20, BASE_LIGHT, BASE_LIGHT, false);
                    this.generateBox(world, box, start + j + 1, j + 1, j, start + 23 - j, j + 1, j, BASE_LIGHT, BASE_LIGHT, false);
                    this.generateBox(world, box, start + j + 8, j + 5, j + 7, start + 16 - j, j + 5, j + 7, BASE_LIGHT, BASE_LIGHT, false);
                }

                this.generateBox(world, box, start + 4, 4, 4, start + 6, 4, 20, BASE_GRAY, BASE_GRAY, false);
                this.generateBox(world, box, start + 7, 4, 4, start + 17, 4, 6, BASE_GRAY, BASE_GRAY, false);
                this.generateBox(world, box, start + 18, 4, 4, start + 20, 4, 20, BASE_GRAY, BASE_GRAY, false);
                this.generateBox(world, box, start + 11, 8, 11, start + 13, 8, 20, BASE_GRAY, BASE_GRAY, false);
                this.placeBlock(world, DOT_DECO_DATA, start + 12, 9, 12, box);
                this.placeBlock(world, DOT_DECO_DATA, start + 12, 9, 15, box);
                this.placeBlock(world, DOT_DECO_DATA, start + 12, 9, 18, box);
                int k = start + (side ? 19 : 5);
                int l = start + (side ? 5 : 19);

                for (int m = 20; m >= 5; m -= 3) {
                    this.placeBlock(world, DOT_DECO_DATA, k, 5, m, box);
                }

                for (int n = 19; n >= 7; n -= 3) {
                    this.placeBlock(world, DOT_DECO_DATA, l, 5, n, box);
                }

                for (int o = 0; o < 4; o++) {
                    int p = side ? start + 24 - (17 - o * 3) : start + 17 - o * 3;
                    this.placeBlock(world, DOT_DECO_DATA, p, 5, 5, box);
                }

                this.placeBlock(world, DOT_DECO_DATA, l, 5, 5, box);
                this.generateBox(world, box, start + 11, 1, 12, start + 13, 7, 12, BASE_GRAY, BASE_GRAY, false);
                this.generateBox(world, box, start + 12, 1, 11, start + 12, 7, 13, BASE_GRAY, BASE_GRAY, false);
            }
        }

        private void generateEntranceArchs(WorldGenLevel world, RandomSource random, BoundingBox box) {
        ...
        private void generateEntranceWall(WorldGenLevel world, RandomSource random, BoundingBox box) {
        ...
        private void generateRoofPiece(WorldGenLevel world, RandomSource random, BoundingBox box) {
        ...
        private void generateLowerWall(WorldGenLevel world, RandomSource random, BoundingBox box) {
        ...
        private void generateMiddleWall(WorldGenLevel world, RandomSource random, BoundingBox box) {
        ...
        private void generateUpperWall(WorldGenLevel world, RandomSource random, BoundingBox box) {
    ...
    interface MonumentRoomFitter {
        ...
        OceanMonumentPieces.OceanMonumentPiece create(Direction direction, OceanMonumentPieces.RoomDefinition setting, RandomSource random);
    }
    ...
    public static class OceanMonumentDoubleYRoom extends OceanMonumentPieces.OceanMonumentPiece {
        ...
        public void postProcess(
            ...
            for (int i = 1; i <= 5; i += 4) {
                ...
                int var13 = 7;
                if (roomDefinition2.hasOpening[Direction.NORTH.get3DDataValue()]) {
                    this.generateBox(world, chunkBox, 2, i, var13, 2, i + 2, var13, BASE_LIGHT, BASE_LIGHT, false);
                    this.generateBox(world, chunkBox, 5, i, var13, 5, i + 2, var13, BASE_LIGHT, BASE_LIGHT, false);
                    this.generateBox(world, chunkBox, 3, i + 2, var13, 4, i + 2, var13, BASE_LIGHT, BASE_LIGHT, false);
                } else {
                    this.generateBox(world, chunkBox, 0, i, var13, 7, i + 2, var13, BASE_LIGHT, BASE_LIGHT, false);
                    this.generateBox(world, chunkBox, 0, i + 1, var13, 7, i + 1, var13, BASE_GRAY, BASE_GRAY, false);
                }
                ...
                if (roomDefinition2.hasOpening[Direction.EAST.get3DDataValue()]) {
                    this.generateBox(world, chunkBox, var14, i, 2, var14, i + 2, 2, BASE_LIGHT, BASE_LIGHT, false);
                    this.generateBox(world, chunkBox, var14, i, 5, var14, i + 2, 5, BASE_LIGHT, BASE_LIGHT, false);
                    this.generateBox(world, chunkBox, var14, i + 2, 3, var14, i + 2, 4, BASE_LIGHT, BASE_LIGHT, false);
                } else {
                    this.generateBox(world, chunkBox, var14, i, 0, var14, i + 2, 7, BASE_LIGHT, BASE_LIGHT, false);
                    this.generateBox(world, chunkBox, var14, i + 1, 0, var14, i + 1, 7, BASE_GRAY, BASE_GRAY, false);
                }
    ...
    protected abstract static class OceanMonumentPiece extends StructurePiece {
        ...
        protected OceanMonumentPiece(
            StructurePieceType type, int length, Direction orientation, OceanMonumentPieces.RoomDefinition setting, int x, int y, int z
        ) {
            super(type, length, makeBoundingBox(orientation, setting, x, y, z));
            this.setOrientation(orientation);
            this.roomDefinition = setting;
        }

        private static BoundingBox makeBoundingBox(Direction orientation, OceanMonumentPieces.RoomDefinition setting, int x, int y, int z) {
            int i = setting.index;
            int j = i % 5;
            int k = i / 5 % 5;
            int l = i / 25;
            BoundingBox boundingBox = makeBoundingBox(0, 0, 0, orientation, x * 8, y * 4, z * 8);
            switch (orientation) {
                case NORTH:
        ...
        protected void generateDefaultFloor(WorldGenLevel world, BoundingBox box, int x, int z, boolean neighbor) {
            if (neighbor) {
        ...
        protected boolean chunkIntersects(BoundingBox box, int x1, int z1, int x2, int z2) {
            int i = this.getWorldX(x1, z1);
            int j = this.getWorldZ(x1, z1);
            int k = this.getWorldX(x2, z2);
            int l = this.getWorldZ(x2, z2);
            return box.intersects(Math.min(i, k), Math.min(j, l), Math.max(i, k), Math.max(j, l));
        }

        protected void spawnElder(WorldGenLevel world, BoundingBox box, int x, int y, int z) {
            ...
            if (box.isInside(blockPos)) {
                ...
                if (elderGuardian != null) {
                    ...
                    elderGuardian.finalizeSpawn(world, world.getCurrentDifficultyAt(elderGuardian.blockPosition()), MobSpawnType.STRUCTURE, null);
    ...
    public static class OceanMonumentSimpleRoom extends OceanMonumentPieces.OceanMonumentPiece {
        ...
        public OceanMonumentSimpleRoom(Direction orientation, OceanMonumentPieces.RoomDefinition setting, RandomSource random) {
    ...
    public static class OceanMonumentWingRoom extends OceanMonumentPieces.OceanMonumentPiece {
        ...
        public OceanMonumentWingRoom(Direction orientation, BoundingBox box, int wing) {
            super(StructurePieceType.OCEAN_MONUMENT_WING_ROOM, orientation, 1, box);
            this.mainDesign = wing & 1;
        }
        ...
        public void postProcess(
            ...
            if (this.mainDesign == 0) {
                ...
                for (int o = 0; o < 2; o++) {
                    this.generateBox(world, chunkBox, var14, 0, 10, var14, 6, 10, BASE_LIGHT, BASE_LIGHT, false);
                    this.generateBox(world, chunkBox, var14, 0, 12, var14, 6, 12, BASE_LIGHT, BASE_LIGHT, false);
                    this.placeBlock(world, LAMP_BLOCK, var14, 0, 10, chunkBox);
                    this.placeBlock(world, LAMP_BLOCK, var14, 0, 12, chunkBox);
                    this.placeBlock(world, LAMP_BLOCK, var14, 4, 10, chunkBox);
                    this.placeBlock(world, LAMP_BLOCK, var14, 4, 12, chunkBox);
                    var14 = 12;
                }
                ...
                for (int p = 0; p < 2; p++) {
                    this.generateBox(world, chunkBox, var14, 0, 7, var14, 2, 7, BASE_LIGHT, BASE_LIGHT, false);
                    this.generateBox(world, chunkBox, var14, 0, 14, var14, 2, 14, BASE_LIGHT, BASE_LIGHT, false);
                    var14 = 14;
                }
    ...
    static class RoomDefinition {
        ...
        public boolean findSource(int distance) {
            if (this.isSource) {
                return true;
            } else {
                this.scanIndex = distance;

                for (int i = 0; i < 6; i++) {
                    if (this.connections[i] != null
                        && this.hasOpening[i]
                        && this.connections[i].scanIndex != distance
                        && this.connections[i].findSource(distance)) {
                        return true;
                    }
                }
