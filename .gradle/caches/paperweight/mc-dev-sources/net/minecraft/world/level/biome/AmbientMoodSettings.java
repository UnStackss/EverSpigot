...
public class AmbientMoodSettings {
    public static final Codec<AmbientMoodSettings> CODEC = RecordCodecBuilder.create(
        instance -> instance.group(
                    ...
                    Codec.DOUBLE.fieldOf("offset").forGetter(sound -> sound.soundPositionOffset)
                )
    ...
    public AmbientMoodSettings(Holder<SoundEvent> sound, int cultivationTicks, int spawnRange, double extraDistance) {
