...
public class PointedDripstoneFeature extends Feature<PointedDripstoneConfiguration> {
    ...
    private static Optional<Direction> getTipDirection(LevelAccessor world, BlockPos pos, RandomSource random) {
    ...
    private static void createPatchOfDripstoneBlocks(LevelAccessor world, RandomSource random, BlockPos pos, PointedDripstoneConfiguration config) {
