...
public class FlowerBlock extends BushBlock implements SuspiciousEffectHolder {
    ...
    public FlowerBlock(Holder<MobEffect> stewEffect, float effectLengthInSeconds, BlockBehaviour.Properties settings) {
        this(makeEffectList(stewEffect, effectLengthInSeconds), settings);
    }

    public FlowerBlock(SuspiciousStewEffects stewEffects, BlockBehaviour.Properties settings) {
        super(settings);
        this.suspiciousStewEffects = stewEffects;
    }
