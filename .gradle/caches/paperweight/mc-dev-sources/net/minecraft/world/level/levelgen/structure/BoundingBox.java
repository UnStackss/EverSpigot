...
public class BoundingBox {
    ...
    public static final Codec<BoundingBox> CODEC = Codec.INT_STREAM
        .<BoundingBox>comapFlatMap(
            values -> Util.fixedSize(values, 6).map(array -> new BoundingBox(array[0], array[1], array[2], array[3], array[4], array[5])),
    ...
    public BoundingBox inflatedBy(int offset) {
        return this.inflatedBy(offset, offset, offset);
    }
    ...
    public boolean equals(Object object) {
        return this == object
            || object instanceof BoundingBox boundingBox
