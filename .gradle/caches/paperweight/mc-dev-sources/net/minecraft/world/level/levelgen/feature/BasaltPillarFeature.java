...
public class BasaltPillarFeature extends Feature<NoneFeatureConfiguration> {
    ...
    private void placeBaseHangOff(LevelAccessor world, RandomSource random, BlockPos pos) {
        if (random.nextBoolean()) {
            world.setBlock(pos, Blocks.BASALT.defaultBlockState(), 2);
        }
    }

    private boolean placeHangOff(LevelAccessor world, RandomSource random, BlockPos pos) {
