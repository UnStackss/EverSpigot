...
public record LootItemRandomChanceWithEnchantedBonusCondition(float unenchantedChance, LevelBasedValue enchantedChance, Holder<Enchantment> enchantment)
    ...
    public static LootItemCondition.Builder randomChanceAndLootingBoost(HolderLookup.Provider registryLookup, float base, float perLevelAboveFirst) {
        ...
        return () -> new LootItemRandomChanceWithEnchantedBonusCondition(
                base, new LevelBasedValue.Linear(base + perLevelAboveFirst, perLevelAboveFirst), registryLookup2.getOrThrow(Enchantments.LOOTING)
            );
    }
}
