...
public record NoiseGeneratorSettings(
    ...
    public static void bootstrap(BootstrapContext<NoiseGeneratorSettings> chunkGenerationSettingsRegisterable) {
        chunkGenerationSettingsRegisterable.register(OVERWORLD, overworld(chunkGenerationSettingsRegisterable, false, false));
        chunkGenerationSettingsRegisterable.register(LARGE_BIOMES, overworld(chunkGenerationSettingsRegisterable, false, true));
        chunkGenerationSettingsRegisterable.register(AMPLIFIED, overworld(chunkGenerationSettingsRegisterable, true, false));
        chunkGenerationSettingsRegisterable.register(NETHER, nether(chunkGenerationSettingsRegisterable));
        chunkGenerationSettingsRegisterable.register(END, end(chunkGenerationSettingsRegisterable));
        chunkGenerationSettingsRegisterable.register(CAVES, caves(chunkGenerationSettingsRegisterable));
        chunkGenerationSettingsRegisterable.register(FLOATING_ISLANDS, floatingIslands(chunkGenerationSettingsRegisterable));
    }

    private static NoiseGeneratorSettings end(BootstrapContext<?> registerable) {
        return new NoiseGeneratorSettings(
            NoiseSettings.END_NOISE_SETTINGS,
            Blocks.END_STONE.defaultBlockState(),
            Blocks.AIR.defaultBlockState(),
            NoiseRouterData.end(registerable.lookup(Registries.DENSITY_FUNCTION)),
            SurfaceRuleData.end(),
            List.of(),
            0,
            true,
    ...
    private static NoiseGeneratorSettings nether(BootstrapContext<?> registerable) {
        return new NoiseGeneratorSettings(
            NoiseSettings.NETHER_NOISE_SETTINGS,
            Blocks.NETHERRACK.defaultBlockState(),
            Blocks.LAVA.defaultBlockState(),
            NoiseRouterData.nether(registerable.lookup(Registries.DENSITY_FUNCTION), registerable.lookup(Registries.NOISE)),
    ...
    private static NoiseGeneratorSettings overworld(BootstrapContext<?> registerable, boolean amplified, boolean largeBiomes) {
        return new NoiseGeneratorSettings(
            NoiseSettings.OVERWORLD_NOISE_SETTINGS,
            Blocks.STONE.defaultBlockState(),
            Blocks.WATER.defaultBlockState(),
            NoiseRouterData.overworld(registerable.lookup(Registries.DENSITY_FUNCTION), registerable.lookup(Registries.NOISE), largeBiomes, amplified),
    ...
    private static NoiseGeneratorSettings caves(BootstrapContext<?> registerable) {
        return new NoiseGeneratorSettings(
            NoiseSettings.CAVES_NOISE_SETTINGS,
            Blocks.STONE.defaultBlockState(),
            Blocks.WATER.defaultBlockState(),
            NoiseRouterData.caves(registerable.lookup(Registries.DENSITY_FUNCTION), registerable.lookup(Registries.NOISE)),
    ...
    private static NoiseGeneratorSettings floatingIslands(BootstrapContext<?> registerable) {
        return new NoiseGeneratorSettings(
            NoiseSettings.FLOATING_ISLANDS_NOISE_SETTINGS,
            Blocks.STONE.defaultBlockState(),
            Blocks.WATER.defaultBlockState(),
            NoiseRouterData.floatingIslands(registerable.lookup(Registries.DENSITY_FUNCTION), registerable.lookup(Registries.NOISE)),
