...
public class DecoratedPotPatterns {
    ...
    @Nullable
    public static ResourceKey<DecoratedPotPattern> getPatternFromItem(Item sherd) {
        return ITEM_TO_POT_TEXTURE.get(sherd);
    }

    private static ResourceKey<DecoratedPotPattern> create(String path) {
        return ResourceKey.create(Registries.DECORATED_POT_PATTERN, ResourceLocation.withDefaultNamespace(path));
    }
    ...
    private static DecoratedPotPattern register(Registry<DecoratedPotPattern> registry, ResourceKey<DecoratedPotPattern> key, String id) {
        return Registry.register(registry, key, new DecoratedPotPattern(ResourceLocation.withDefaultNamespace(id)));
    }
}
