...
public class RootSystemFeature extends Feature<RootSystemConfiguration> {
    ...
    private static boolean placeDirtAndTree(
        WorldGenLevel world, ChunkGenerator generator, RootSystemConfiguration config, RandomSource random, BlockPos.MutableBlockPos mutablePos, BlockPos pos
    ) {
    ...
    private static void placeDirt(BlockPos pos, int maxY, WorldGenLevel world, RootSystemConfiguration config, RandomSource random) {
        int i = pos.getX();
        int j = pos.getZ();
        BlockPos.MutableBlockPos mutableBlockPos = pos.mutable();
    ...
    private static void placeRootedDirt(
        WorldGenLevel world, RootSystemConfiguration config, RandomSource random, int x, int z, BlockPos.MutableBlockPos mutablePos
    ) {
    ...
    private static void placeRoots(WorldGenLevel world, RootSystemConfiguration config, RandomSource random, BlockPos pos, BlockPos.MutableBlockPos mutablePos) {
