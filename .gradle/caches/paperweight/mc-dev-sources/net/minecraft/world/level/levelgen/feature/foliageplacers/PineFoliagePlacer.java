...
public class PineFoliagePlacer extends FoliagePlacer {
    public static final MapCodec<PineFoliagePlacer> CODEC = RecordCodecBuilder.mapCodec(
        instance -> foliagePlacerParts(instance)
                .and(IntProvider.codec(0, 24).fieldOf("height").forGetter(placer -> placer.height))
    ...
    protected void createFoliage(
        ...
        for (int j = offset; j >= offset - foliageHeight; j--) {
            this.placeLeavesRow(world, placer, random, config, treeNode.pos(), i, j, treeNode.doubleTrunk());
