...
public interface VerticalAnchor {
    ...
    private static Either<VerticalAnchor.Absolute, Either<VerticalAnchor.AboveBottom, VerticalAnchor.BelowTop>> split(VerticalAnchor yOffset) {
        return yOffset instanceof VerticalAnchor.Absolute
            ? Either.left((VerticalAnchor.Absolute)yOffset)
            : Either.right(
                yOffset instanceof VerticalAnchor.AboveBottom
                    ? Either.left((VerticalAnchor.AboveBottom)yOffset)
                    : Either.right((VerticalAnchor.BelowTop)yOffset)
            );
    }
