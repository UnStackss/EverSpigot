...
public class CoralMushroomFeature extends CoralFeature {
    ...
    @Override
    protected boolean placeFeature(LevelAccessor world, RandomSource random, BlockPos pos, BlockState state) {
            ...
            for (int n = 0; n <= i; n++) {
                for (int o = 0; o <= k; o++) {
                    ...
                    if ((m != 0 && m != j || n != 0 && n != i)
                        ...
                        && !this.placeCoralBlock(world, random, mutableBlockPos, state)) {
                    }
                }
            }
        }
