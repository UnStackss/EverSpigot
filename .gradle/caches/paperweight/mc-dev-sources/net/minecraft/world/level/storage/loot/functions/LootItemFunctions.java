...
public class LootItemFunctions {
    ...
    private static <T extends LootItemFunction> LootItemFunctionType<T> register(String id, MapCodec<T> codec) {
        return Registry.register(BuiltInRegistries.LOOT_FUNCTION_TYPE, ResourceLocation.withDefaultNamespace(id), new LootItemFunctionType<>(codec));
    }

    public static BiFunction<ItemStack, LootContext, ItemStack> compose(List<? extends BiFunction<ItemStack, LootContext, ItemStack>> terms) {
