...
public class BannerPatterns {
    ...
    private static ResourceKey<BannerPattern> create(String id) {
        return ResourceKey.create(Registries.BANNER_PATTERN, ResourceLocation.withDefaultNamespace(id));
    }
    ...
    public static void register(BootstrapContext<BannerPattern> registry, ResourceKey<BannerPattern> key) {
        registry.register(key, new BannerPattern(key.location(), "block.minecraft.banner." + key.location().toShortLanguageKey()));
    }
}
