...
public class WeepingVinesFeature extends Feature<NoneFeatureConfiguration> {
    ...
    private void placeRoofNetherWart(LevelAccessor world, RandomSource random, BlockPos pos) {
    ...
    private void placeRoofWeepingVines(LevelAccessor world, RandomSource random, BlockPos pos) {
        BlockPos.MutableBlockPos mutableBlockPos = new BlockPos.MutableBlockPos();
    ...
    public static void placeWeepingVinesColumn(LevelAccessor world, RandomSource random, BlockPos.MutableBlockPos pos, int length, int minAge, int maxAge) {
