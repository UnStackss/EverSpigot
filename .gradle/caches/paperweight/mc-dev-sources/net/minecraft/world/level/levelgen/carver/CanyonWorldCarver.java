...
public class CanyonWorldCarver extends WorldCarver<CanyonCarverConfiguration> {
    ...
    private void doCarve(
        ...
        for (int i = branchStartIndex; i < branchCount; i++) {
            ...
            e = this.updateVerticalRadius(config, randomSource, e, (float)branchCount, (float)i);
            ...
            if (randomSource.nextInt(4) != 0) {
                ...
                this.carveEllipsoid(
                    ...
                    e,
                    mask,
                    (contextx, scaledRelativeX, scaledRelativeY, scaledRelativeZ, yx) -> this.shouldSkip(
    ...
    private boolean shouldSkip(
        CarvingContext context, float[] horizontalStretchFactors, double scaledRelativeX, double scaledRelativeY, double scaledRelativeZ, int y
    ) {
