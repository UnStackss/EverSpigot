...
public class SimpleReloadInstance<S> implements ReloadInstance {
    ...
    public static ReloadInstance create(
        ...
        return (ReloadInstance)(profiled
            ? new ProfiledReloadInstance(manager, reloaders, prepareExecutor, applyExecutor, initialStage)
            : of(manager, reloaders, prepareExecutor, applyExecutor, initialStage));
    }
