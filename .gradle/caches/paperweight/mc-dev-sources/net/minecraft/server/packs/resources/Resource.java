...
public class Resource {
    ...
    public Resource(PackResources pack, IoSupplier<InputStream> inputSupplier, IoSupplier<ResourceMetadata> metadataSupplier) {
        this.source = pack;
        this.streamSupplier = inputSupplier;
        this.metadataSupplier = metadataSupplier;
    }

    public Resource(PackResources pack, IoSupplier<InputStream> inputSupplier) {
        this.source = pack;
        this.streamSupplier = inputSupplier;
