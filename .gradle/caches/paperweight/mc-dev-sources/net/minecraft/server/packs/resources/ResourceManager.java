...
public interface ResourceManager extends ResourceProvider {
    ...
    List<Resource> getResourceStack(ResourceLocation id);

    Map<ResourceLocation, Resource> listResources(String startingPath, Predicate<ResourceLocation> allowedPathPredicate);

    Map<ResourceLocation, List<Resource>> listResourceStacks(String startingPath, Predicate<ResourceLocation> allowedPathPredicate);
