...
public class EndFeatures {
    ...
    public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> featureRegisterable) {
        FeatureUtils.register(featureRegisterable, END_PLATFORM, Feature.END_PLATFORM);
        FeatureUtils.register(featureRegisterable, END_SPIKE, Feature.END_SPIKE, new SpikeConfiguration(false, ImmutableList.of(), null));
        FeatureUtils.register(
            featureRegisterable, END_GATEWAY_RETURN, Feature.END_GATEWAY, EndGatewayConfiguration.knownExit(ServerLevel.END_SPAWN_POINT, true)
        );
        FeatureUtils.register(featureRegisterable, END_GATEWAY_DELAYED, Feature.END_GATEWAY, EndGatewayConfiguration.delayedExitSearch());
        FeatureUtils.register(featureRegisterable, CHORUS_PLANT, Feature.CHORUS_PLANT);
        FeatureUtils.register(featureRegisterable, END_ISLAND, Feature.END_ISLAND);
    }
}
