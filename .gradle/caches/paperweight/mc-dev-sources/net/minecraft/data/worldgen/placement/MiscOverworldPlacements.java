...
public class MiscOverworldPlacements {
    ...
    public static void bootstrap(BootstrapContext<PlacedFeature> featureRegisterable) {
        ...
        PlacementUtils.register(
            featureRegisterable, ICE_SPIKE, holder, CountPlacement.of(3), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()
        );
        PlacementUtils.register(
            featureRegisterable,
            ICE_PATCH,
        ...
        PlacementUtils.register(
            featureRegisterable, FOREST_ROCK, holder3, CountPlacement.of(2), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()
        );
        PlacementUtils.register(
            featureRegisterable, ICEBERG_BLUE, holder5, RarityFilter.onAverageOnceEvery(200), InSquarePlacement.spread(), BiomeFilter.biome()
        );
        PlacementUtils.register(
            featureRegisterable, ICEBERG_PACKED, holder4, RarityFilter.onAverageOnceEvery(16), InSquarePlacement.spread(), BiomeFilter.biome()
        );
        PlacementUtils.register(
            featureRegisterable,
            BLUE_ICE,
        ...
        PlacementUtils.register(featureRegisterable, FREEZE_TOP_LAYER, holder12, BiomeFilter.biome());
        PlacementUtils.register(featureRegisterable, VOID_START_PLATFORM, holder13, BiomeFilter.biome());
        PlacementUtils.register(
            featureRegisterable,
            DESERT_WELL,
            holder14,
