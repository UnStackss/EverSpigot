...
public class Structures {
    public static void bootstrap(BootstrapContext<Structure> structureRegisterable) {
        HolderGetter<Biome> holderGetter = structureRegisterable.lookup(Registries.BIOME);
        HolderGetter<StructureTemplatePool> holderGetter2 = structureRegisterable.lookup(Registries.TEMPLATE_POOL);
        ...
        structureRegisterable.register(
            BuiltinStructures.IGLOO, new IglooStructure(new Structure.StructureSettings(holderGetter.getOrThrow(BiomeTags.HAS_IGLOO)))
        );
        structureRegisterable.register(
        ...
        structureRegisterable.register(
            BuiltinStructures.END_CITY, new EndCityStructure(new Structure.StructureSettings(holderGetter.getOrThrow(BiomeTags.HAS_END_CITY)))
        );
        structureRegisterable.register(
                ...
                new Structure.StructureSettings.Builder(holderGetter.getOrThrow(BiomeTags.HAS_ANCIENT_CITY))
                    .spawnOverrides(
                        Arrays.stream(MobCategory.values())
                            .collect(
                                Collectors.toMap(
                                    spawnGroup -> (MobCategory)spawnGroup,
                                    spawnGroup -> new StructureSpawnOverride(StructureSpawnOverride.BoundingBoxType.STRUCTURE, WeightedRandomList.create())
                                )
                            )
                    )
                    .generationStep(GenerationStep.Decoration.UNDERGROUND_DECORATION)
                    ...
                    .spawnOverrides(
                        Arrays.stream(MobCategory.values())
                            .collect(
                                Collectors.toMap(
                                    spawnGroup -> (MobCategory)spawnGroup,
                                    spawnGroup -> new StructureSpawnOverride(StructureSpawnOverride.BoundingBoxType.PIECE, WeightedRandomList.create())
                                )
                            )
                    )
                    .build(),
