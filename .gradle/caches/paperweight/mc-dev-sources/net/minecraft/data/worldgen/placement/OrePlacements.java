...
public class OrePlacements {
    ...
    public static void bootstrap(BootstrapContext<PlacedFeature> featureRegisterable) {
        ...
        PlacementUtils.register(
            ...
            ORE_MAGMA,
            holder,
            commonOrePlacement(4, HeightRangePlacement.uniform(VerticalAnchor.absolute(27), VerticalAnchor.absolute(36)))
        );
        PlacementUtils.register(
            featureRegisterable,
            ORE_SOUL_SAND,
            holder2,
            commonOrePlacement(12, HeightRangePlacement.uniform(VerticalAnchor.bottom(), VerticalAnchor.absolute(31)))
        );
        PlacementUtils.register(featureRegisterable, ORE_GOLD_DELTAS, holder3, commonOrePlacement(20, PlacementUtils.RANGE_10_10));
        PlacementUtils.register(featureRegisterable, ORE_QUARTZ_DELTAS, holder4, commonOrePlacement(32, PlacementUtils.RANGE_10_10));
        PlacementUtils.register(featureRegisterable, ORE_GOLD_NETHER, holder3, commonOrePlacement(10, PlacementUtils.RANGE_10_10));
        PlacementUtils.register(featureRegisterable, ORE_QUARTZ_NETHER, holder4, commonOrePlacement(16, PlacementUtils.RANGE_10_10));
        PlacementUtils.register(
            featureRegisterable,
            ORE_GRAVEL_NETHER,
            holder5,
        ...
        PlacementUtils.register(
            featureRegisterable, ORE_GRAVEL, holder8, commonOrePlacement(14, HeightRangePlacement.uniform(VerticalAnchor.bottom(), VerticalAnchor.top()))
        );
        PlacementUtils.register(
            featureRegisterable,
            ORE_GRANITE_UPPER,
        ...
        PlacementUtils.register(
            featureRegisterable, ORE_TUFF, holder12, commonOrePlacement(2, HeightRangePlacement.uniform(VerticalAnchor.bottom(), VerticalAnchor.absolute(0)))
        );
        PlacementUtils.register(
            featureRegisterable,
            ORE_COAL_UPPER,
        ...
        PlacementUtils.register(
            ...
            ORE_INFESTED,
            holder26,
            commonOrePlacement(14, HeightRangePlacement.uniform(VerticalAnchor.bottom(), VerticalAnchor.absolute(63)))
        );
        PlacementUtils.register(
            featureRegisterable,
            ORE_EMERALD,
        ...
        PlacementUtils.register(
            featureRegisterable, ORE_ANCIENT_DEBRIS_SMALL, holder29, InSquarePlacement.spread(), PlacementUtils.RANGE_8_8, BiomeFilter.biome()
        );
        PlacementUtils.register(
            featureRegisterable,
            ORE_COPPER,
        ...
        PlacementUtils.register(featureRegisterable, ORE_CLAY, holder32, commonOrePlacement(46, PlacementUtils.RANGE_BOTTOM_TO_MAX_TERRAIN_HEIGHT));
    }
}
