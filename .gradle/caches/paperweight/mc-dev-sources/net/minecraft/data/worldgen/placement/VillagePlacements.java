...
public class VillagePlacements {
    ...
    public static void bootstrap(BootstrapContext<PlacedFeature> featureRegisterable) {
        ...
        PlacementUtils.register(featureRegisterable, PILE_HAY_VILLAGE, holder);
        PlacementUtils.register(featureRegisterable, PILE_MELON_VILLAGE, holder2);
        PlacementUtils.register(featureRegisterable, PILE_SNOW_VILLAGE, holder3);
        PlacementUtils.register(featureRegisterable, PILE_ICE_VILLAGE, holder4);
        PlacementUtils.register(featureRegisterable, PILE_PUMPKIN_VILLAGE, holder5);
        PlacementUtils.register(featureRegisterable, OAK_VILLAGE, holder6, PlacementUtils.filteredByBlockSurvival(Blocks.OAK_SAPLING));
        PlacementUtils.register(featureRegisterable, ACACIA_VILLAGE, holder7, PlacementUtils.filteredByBlockSurvival(Blocks.ACACIA_SAPLING));
        PlacementUtils.register(featureRegisterable, SPRUCE_VILLAGE, holder8, PlacementUtils.filteredByBlockSurvival(Blocks.SPRUCE_SAPLING));
        PlacementUtils.register(featureRegisterable, PINE_VILLAGE, holder9, PlacementUtils.filteredByBlockSurvival(Blocks.SPRUCE_SAPLING));
        PlacementUtils.register(featureRegisterable, PATCH_CACTUS_VILLAGE, holder10);
        PlacementUtils.register(featureRegisterable, FLOWER_PLAIN_VILLAGE, holder11);
        PlacementUtils.register(featureRegisterable, PATCH_TAIGA_GRASS_VILLAGE, holder12);
        PlacementUtils.register(featureRegisterable, PATCH_BERRY_BUSH_VILLAGE, holder13);
    }
}
