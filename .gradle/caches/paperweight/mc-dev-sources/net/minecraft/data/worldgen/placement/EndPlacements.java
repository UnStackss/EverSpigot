...
public class EndPlacements {
    ...
    public static void bootstrap(BootstrapContext<PlacedFeature> featureRegisterable) {
        ...
        PlacementUtils.register(featureRegisterable, END_PLATFORM, holder, FixedPlacement.of(ServerLevel.END_SPAWN_POINT.below()), BiomeFilter.biome());
        PlacementUtils.register(featureRegisterable, END_SPIKE, holder2, BiomeFilter.biome());
