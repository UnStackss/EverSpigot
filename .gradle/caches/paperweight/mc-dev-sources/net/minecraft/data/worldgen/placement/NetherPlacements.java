...
public class NetherPlacements {
    ...
    public static void bootstrap(BootstrapContext<PlacedFeature> featureRegisterable) {
        ...
        PlacementUtils.register(featureRegisterable, DELTA, holder, CountOnEveryLayerPlacement.of(40), BiomeFilter.biome());
        PlacementUtils.register(featureRegisterable, SMALL_BASALT_COLUMNS, holder2, CountOnEveryLayerPlacement.of(4), BiomeFilter.biome());
        PlacementUtils.register(featureRegisterable, LARGE_BASALT_COLUMNS, holder3, CountOnEveryLayerPlacement.of(2), BiomeFilter.biome());
        PlacementUtils.register(
            featureRegisterable, BASALT_BLOBS, holder4, CountPlacement.of(75), InSquarePlacement.spread(), PlacementUtils.FULL_RANGE, BiomeFilter.biome()
        );
        PlacementUtils.register(
            featureRegisterable, BLACKSTONE_BLOBS, holder5, CountPlacement.of(25), InSquarePlacement.spread(), PlacementUtils.FULL_RANGE, BiomeFilter.biome()
        );
        PlacementUtils.register(
            featureRegisterable,
            GLOWSTONE_EXTRA,
        ...
        PlacementUtils.register(
            featureRegisterable, GLOWSTONE, holder6, CountPlacement.of(10), InSquarePlacement.spread(), PlacementUtils.FULL_RANGE, BiomeFilter.biome()
        );
        PlacementUtils.register(featureRegisterable, CRIMSON_FOREST_VEGETATION, holder7, CountOnEveryLayerPlacement.of(6), BiomeFilter.biome());
        PlacementUtils.register(featureRegisterable, WARPED_FOREST_VEGETATION, holder8, CountOnEveryLayerPlacement.of(5), BiomeFilter.biome());
        PlacementUtils.register(featureRegisterable, NETHER_SPROUTS, holder9, CountOnEveryLayerPlacement.of(4), BiomeFilter.biome());
        PlacementUtils.register(
            featureRegisterable, TWISTING_VINES, holder10, CountPlacement.of(10), InSquarePlacement.spread(), PlacementUtils.FULL_RANGE, BiomeFilter.biome()
        );
        PlacementUtils.register(
            featureRegisterable, WEEPING_VINES, holder11, CountPlacement.of(10), InSquarePlacement.spread(), PlacementUtils.FULL_RANGE, BiomeFilter.biome()
        );
        PlacementUtils.register(featureRegisterable, PATCH_CRIMSON_ROOTS, holder12, PlacementUtils.FULL_RANGE, BiomeFilter.biome());
        PlacementUtils.register(
            featureRegisterable, BASALT_PILLAR, holder13, CountPlacement.of(10), InSquarePlacement.spread(), PlacementUtils.FULL_RANGE, BiomeFilter.biome()
        );
        PlacementUtils.register(
            featureRegisterable, SPRING_DELTA, holder14, CountPlacement.of(16), InSquarePlacement.spread(), PlacementUtils.RANGE_4_4, BiomeFilter.biome()
        );
        PlacementUtils.register(
            featureRegisterable, SPRING_CLOSED, holder15, CountPlacement.of(16), InSquarePlacement.spread(), PlacementUtils.RANGE_10_10, BiomeFilter.biome()
        );
        PlacementUtils.register(
            featureRegisterable,
        ...
        PlacementUtils.register(
            featureRegisterable, SPRING_OPEN, holder16, CountPlacement.of(8), InSquarePlacement.spread(), PlacementUtils.RANGE_4_4, BiomeFilter.biome()
        );
        ...
        PlacementUtils.register(featureRegisterable, PATCH_SOUL_FIRE, holder17, list);
        PlacementUtils.register(featureRegisterable, PATCH_FIRE, holder18, list);
    }
}
