...
public class Carvers {
    ...
    private static ResourceKey<ConfiguredWorldCarver<?>> createKey(String id) {
        return ResourceKey.create(Registries.CONFIGURED_CARVER, ResourceLocation.withDefaultNamespace(id));
    }

    public static void bootstrap(BootstrapContext<ConfiguredWorldCarver<?>> carverRegisterable) {
        HolderGetter<Block> holderGetter = carverRegisterable.lookup(Registries.BLOCK);
