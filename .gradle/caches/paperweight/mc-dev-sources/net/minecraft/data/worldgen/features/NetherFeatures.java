...
public class NetherFeatures {
    ...
    public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> featureRegisterable) {
        ...
        FeatureUtils.register(
            featureRegisterable, SMALL_BASALT_COLUMNS, Feature.BASALT_COLUMNS, new ColumnFeatureConfiguration(ConstantInt.of(1), UniformInt.of(1, 4))
        );
        FeatureUtils.register(
            featureRegisterable, LARGE_BASALT_COLUMNS, Feature.BASALT_COLUMNS, new ColumnFeatureConfiguration(UniformInt.of(2, 3), UniformInt.of(5, 10))
        );
        FeatureUtils.register(
            featureRegisterable,
            BASALT_BLOBS,
        ...
        FeatureUtils.register(featureRegisterable, GLOWSTONE_EXTRA, Feature.GLOWSTONE_BLOB);
        ...
        FeatureUtils.register(
            featureRegisterable, CRIMSON_FOREST_VEGETATION, Feature.NETHER_FOREST_VEGETATION, new NetherForestVegetationConfig(weightedStateProvider, 8, 4)
        );
        FeatureUtils.register(
            featureRegisterable,
            CRIMSON_FOREST_VEGETATION_BONEMEAL,
            Feature.NETHER_FOREST_VEGETATION,
            new NetherForestVegetationConfig(weightedStateProvider, 3, 1)
        );
        ...
        FeatureUtils.register(
            featureRegisterable, WARPED_FOREST_VEGETION, Feature.NETHER_FOREST_VEGETATION, new NetherForestVegetationConfig(weightedStateProvider2, 8, 4)
        );
        FeatureUtils.register(
            featureRegisterable,
            WARPED_FOREST_VEGETATION_BONEMEAL,
            Feature.NETHER_FOREST_VEGETATION,
            new NetherForestVegetationConfig(weightedStateProvider2, 3, 1)
        );
        FeatureUtils.register(
            featureRegisterable,
            NETHER_SPROUTS,
        ...
        FeatureUtils.register(featureRegisterable, TWISTING_VINES, Feature.TWISTING_VINES, new TwistingVinesConfig(8, 4, 8));
        FeatureUtils.register(featureRegisterable, TWISTING_VINES_BONEMEAL, Feature.TWISTING_VINES, new TwistingVinesConfig(3, 1, 2));
        FeatureUtils.register(featureRegisterable, WEEPING_VINES, Feature.WEEPING_VINES);
        FeatureUtils.register(
            featureRegisterable,
            PATCH_CRIMSON_ROOTS,
        ...
        FeatureUtils.register(featureRegisterable, BASALT_PILLAR, Feature.BASALT_PILLAR);
        FeatureUtils.register(
            featureRegisterable,
            SPRING_LAVA_NETHER,
            Feature.SPRING,
