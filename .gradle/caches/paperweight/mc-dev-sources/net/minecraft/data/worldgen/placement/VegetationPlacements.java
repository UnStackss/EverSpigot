...
public class VegetationPlacements {
    ...
    public static void bootstrap(BootstrapContext<PlacedFeature> featureRegisterable) {
        ...
        PlacementUtils.register(featureRegisterable, PATCH_GRASS_FOREST, holder6, worldSurfaceSquaredWithCount(2));
        PlacementUtils.register(
            featureRegisterable, PATCH_GRASS_BADLANDS, holder6, InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE, BiomeFilter.biome()
        );
        PlacementUtils.register(featureRegisterable, PATCH_GRASS_SAVANNA, holder6, worldSurfaceSquaredWithCount(20));
        PlacementUtils.register(featureRegisterable, PATCH_GRASS_NORMAL, holder6, worldSurfaceSquaredWithCount(5));
        PlacementUtils.register(
            featureRegisterable, PATCH_GRASS_TAIGA_2, holder7, InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE, BiomeFilter.biome()
        );
        PlacementUtils.register(featureRegisterable, PATCH_GRASS_TAIGA, holder7, worldSurfaceSquaredWithCount(7));
        PlacementUtils.register(featureRegisterable, PATCH_GRASS_JUNGLE, holder8, worldSurfaceSquaredWithCount(25));
        PlacementUtils.register(featureRegisterable, GRASS_BONEMEAL, holder9, PlacementUtils.isEmpty());
        PlacementUtils.register(featureRegisterable, PATCH_DEAD_BUSH_2, holder10, worldSurfaceSquaredWithCount(2));
        PlacementUtils.register(
            featureRegisterable, PATCH_DEAD_BUSH, holder10, InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE, BiomeFilter.biome()
        );
        PlacementUtils.register(featureRegisterable, PATCH_DEAD_BUSH_BADLANDS, holder10, worldSurfaceSquaredWithCount(20));
        PlacementUtils.register(
            featureRegisterable,
            PATCH_MELON,
            holder11,
        ...
        PlacementUtils.register(featureRegisterable, PATCH_WATERLILY, holder13, worldSurfaceSquaredWithCount(4));
        PlacementUtils.register(
            featureRegisterable,
            PATCH_TALL_GRASS_2,
            holder14,
        ...
        PlacementUtils.register(
            featureRegisterable, PATCH_SUGAR_CANE_DESERT, holder17, InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()
        );
        PlacementUtils.register(
            featureRegisterable,
        ...
        PlacementUtils.register(featureRegisterable, BROWN_MUSHROOM_NORMAL, holder18, getMushroomPlacement(256, null));
        PlacementUtils.register(featureRegisterable, RED_MUSHROOM_NORMAL, holder19, getMushroomPlacement(512, null));
        PlacementUtils.register(featureRegisterable, BROWN_MUSHROOM_TAIGA, holder18, getMushroomPlacement(4, null));
        PlacementUtils.register(featureRegisterable, RED_MUSHROOM_TAIGA, holder19, getMushroomPlacement(256, null));
        PlacementUtils.register(featureRegisterable, BROWN_MUSHROOM_OLD_GROWTH, holder18, getMushroomPlacement(4, CountPlacement.of(3)));
        PlacementUtils.register(featureRegisterable, RED_MUSHROOM_OLD_GROWTH, holder19, getMushroomPlacement(171, null));
        PlacementUtils.register(featureRegisterable, BROWN_MUSHROOM_SWAMP, holder18, getMushroomPlacement(0, CountPlacement.of(2)));
        PlacementUtils.register(featureRegisterable, RED_MUSHROOM_SWAMP, holder19, getMushroomPlacement(64, null));
        PlacementUtils.register(
            featureRegisterable,
            FLOWER_WARM,
            holder20,
        ...
        PlacementUtils.register(featureRegisterable, FLOWER_MEADOW, holder24, InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());
        ...
        PlacementUtils.register(featureRegisterable, TREES_FLOWER_FOREST, holder29, treePlacement(PlacementUtils.countExtra(6, 0.1F, 1)));
        PlacementUtils.register(featureRegisterable, TREES_MEADOW, holder30, treePlacement(RarityFilter.onAverageOnceEvery(100)));
        PlacementUtils.register(featureRegisterable, TREES_CHERRY, holder35, treePlacement(PlacementUtils.countExtra(10, 0.1F, 1), Blocks.CHERRY_SAPLING));
        PlacementUtils.register(featureRegisterable, TREES_TAIGA, holder31, treePlacement(PlacementUtils.countExtra(10, 0.1F, 1)));
        PlacementUtils.register(featureRegisterable, TREES_GROVE, holder32, treePlacement(PlacementUtils.countExtra(10, 0.1F, 1)));
        PlacementUtils.register(featureRegisterable, TREES_BADLANDS, holder33, treePlacement(PlacementUtils.countExtra(5, 0.1F, 1), Blocks.OAK_SAPLING));
        PlacementUtils.register(featureRegisterable, TREES_SNOWY, holder34, treePlacement(PlacementUtils.countExtra(0, 0.1F, 1), Blocks.SPRUCE_SAPLING));
        PlacementUtils.register(
            featureRegisterable,
            TREES_SWAMP,
            holder36,
        ...
        PlacementUtils.register(featureRegisterable, TREES_WINDSWEPT_SAVANNA, holder37, treePlacement(PlacementUtils.countExtra(2, 0.1F, 1)));
        PlacementUtils.register(featureRegisterable, TREES_SAVANNA, holder37, treePlacement(PlacementUtils.countExtra(1, 0.1F, 1)));
        PlacementUtils.register(featureRegisterable, BIRCH_TALL, holder38, treePlacement(PlacementUtils.countExtra(10, 0.1F, 1)));
        PlacementUtils.register(featureRegisterable, TREES_BIRCH, holder39, treePlacement(PlacementUtils.countExtra(10, 0.1F, 1), Blocks.BIRCH_SAPLING));
        PlacementUtils.register(featureRegisterable, TREES_WINDSWEPT_FOREST, holder40, treePlacement(PlacementUtils.countExtra(3, 0.1F, 1)));
        PlacementUtils.register(featureRegisterable, TREES_WINDSWEPT_HILLS, holder40, treePlacement(PlacementUtils.countExtra(0, 0.1F, 1)));
        PlacementUtils.register(featureRegisterable, TREES_WATER, holder41, treePlacement(PlacementUtils.countExtra(0, 0.1F, 1)));
        PlacementUtils.register(featureRegisterable, TREES_BIRCH_AND_OAK, holder42, treePlacement(PlacementUtils.countExtra(10, 0.1F, 1)));
        PlacementUtils.register(featureRegisterable, TREES_SPARSE_JUNGLE, holder43, treePlacement(PlacementUtils.countExtra(2, 0.1F, 1)));
        PlacementUtils.register(featureRegisterable, TREES_OLD_GROWTH_SPRUCE_TAIGA, holder44, treePlacement(PlacementUtils.countExtra(10, 0.1F, 1)));
        PlacementUtils.register(featureRegisterable, TREES_OLD_GROWTH_PINE_TAIGA, holder45, treePlacement(PlacementUtils.countExtra(10, 0.1F, 1)));
        PlacementUtils.register(featureRegisterable, TREES_JUNGLE, holder46, treePlacement(PlacementUtils.countExtra(50, 0.1F, 1)));
        PlacementUtils.register(featureRegisterable, BAMBOO_VEGETATION, holder47, treePlacement(PlacementUtils.countExtra(30, 0.1F, 1)));
        PlacementUtils.register(
            featureRegisterable, MUSHROOM_ISLAND_VEGETATION, holder48, InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()
        );
        PlacementUtils.register(
            featureRegisterable,
            TREES_MANGROVE,
