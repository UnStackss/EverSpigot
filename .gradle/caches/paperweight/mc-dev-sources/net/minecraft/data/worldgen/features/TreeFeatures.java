...
public class TreeFeatures {
    ...
    private static TreeConfiguration.TreeConfigurationBuilder createStraightBlobTree(
        Block log, Block leaves, int baseHeight, int firstRandomHeight, int secondRandomHeight, int radius
    ) {
    ...
    public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> featureRegisterable) {
        HolderGetter<Block> holderGetter = featureRegisterable.lookup(Registries.BLOCK);
        ...
        FeatureUtils.register(featureRegisterable, OAK, Feature.TREE, createOak().build());
        FeatureUtils.register(
            featureRegisterable,
            DARK_OAK,
            Feature.TREE,
        ...
        FeatureUtils.register(featureRegisterable, BIRCH, Feature.TREE, createBirch().build());
        FeatureUtils.register(
            featureRegisterable,
            ACACIA,
            Feature.TREE,
        ...
        FeatureUtils.register(featureRegisterable, CHERRY, Feature.TREE, cherry().build());
        FeatureUtils.register(featureRegisterable, CHERRY_BEES_005, Feature.TREE, cherry().decorators(List.of(beehiveDecorator4)).build());
        FeatureUtils.register(
            featureRegisterable,
            SPRUCE,
            Feature.TREE,
        ...
        FeatureUtils.register(featureRegisterable, FANCY_OAK, Feature.TREE, createFancyOak().build());
        FeatureUtils.register(featureRegisterable, JUNGLE_TREE_NO_VINE, Feature.TREE, createJungleTree().ignoreVines().build());
        FeatureUtils.register(
            featureRegisterable,
            MEGA_JUNGLE_TREE,
            Feature.TREE,
        ...
        FeatureUtils.register(
            featureRegisterable, SUPER_BIRCH_BEES_0002, Feature.TREE, createSuperBirch().decorators(ImmutableList.of(beehiveDecorator)).build()
        );
        FeatureUtils.register(featureRegisterable, SUPER_BIRCH_BEES, Feature.TREE, createSuperBirch().decorators(ImmutableList.of(beehiveDecorator5)).build());
        FeatureUtils.register(
            featureRegisterable,
            SWAMP_OAK,
            Feature.TREE,
        ...
        FeatureUtils.register(featureRegisterable, OAK_BEES_0002, Feature.TREE, createOak().decorators(List.of(beehiveDecorator)).build());
        FeatureUtils.register(featureRegisterable, OAK_BEES_002, Feature.TREE, createOak().decorators(List.of(beehiveDecorator3)).build());
        FeatureUtils.register(featureRegisterable, OAK_BEES_005, Feature.TREE, createOak().decorators(List.of(beehiveDecorator4)).build());
        FeatureUtils.register(featureRegisterable, BIRCH_BEES_0002, Feature.TREE, createBirch().decorators(List.of(beehiveDecorator)).build());
        FeatureUtils.register(featureRegisterable, BIRCH_BEES_002, Feature.TREE, createBirch().decorators(List.of(beehiveDecorator3)).build());
        FeatureUtils.register(featureRegisterable, BIRCH_BEES_005, Feature.TREE, createBirch().decorators(List.of(beehiveDecorator4)).build());
        FeatureUtils.register(featureRegisterable, FANCY_OAK_BEES_0002, Feature.TREE, createFancyOak().decorators(List.of(beehiveDecorator)).build());
        FeatureUtils.register(featureRegisterable, FANCY_OAK_BEES_002, Feature.TREE, createFancyOak().decorators(List.of(beehiveDecorator3)).build());
        FeatureUtils.register(featureRegisterable, FANCY_OAK_BEES_005, Feature.TREE, createFancyOak().decorators(List.of(beehiveDecorator4)).build());
        FeatureUtils.register(featureRegisterable, FANCY_OAK_BEES, Feature.TREE, createFancyOak().decorators(List.of(beehiveDecorator5)).build());
    }
}
