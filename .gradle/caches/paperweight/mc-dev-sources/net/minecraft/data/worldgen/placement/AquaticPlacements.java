...
public class AquaticPlacements {
    ...
    public static void bootstrap(BootstrapContext<PlacedFeature> featureRegisterable) {
        ...
        PlacementUtils.register(featureRegisterable, SEAGRASS_WARM, reference, seagrassPlacement(80));
        PlacementUtils.register(featureRegisterable, SEAGRASS_NORMAL, reference, seagrassPlacement(48));
        PlacementUtils.register(featureRegisterable, SEAGRASS_COLD, reference, seagrassPlacement(32));
        PlacementUtils.register(featureRegisterable, SEAGRASS_RIVER, reference2, seagrassPlacement(48));
        PlacementUtils.register(featureRegisterable, SEAGRASS_SWAMP, reference3, seagrassPlacement(64));
        PlacementUtils.register(featureRegisterable, SEAGRASS_DEEP_WARM, reference4, seagrassPlacement(80));
        PlacementUtils.register(featureRegisterable, SEAGRASS_DEEP, reference4, seagrassPlacement(48));
        PlacementUtils.register(featureRegisterable, SEAGRASS_DEEP_COLD, reference4, seagrassPlacement(40));
