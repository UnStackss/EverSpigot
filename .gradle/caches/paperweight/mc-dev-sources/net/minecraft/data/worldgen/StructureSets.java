...
public interface StructureSets {
    static void bootstrap(BootstrapContext<StructureSet> structureSetRegisterable) {
        HolderGetter<Structure> holderGetter = structureSetRegisterable.lookup(Registries.STRUCTURE);
        HolderGetter<Biome> holderGetter2 = structureSetRegisterable.lookup(Registries.BIOME);
        Holder.Reference<StructureSet> reference = structureSetRegisterable.register(
