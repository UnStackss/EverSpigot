...
public class ProcessorLists {
    ...
    private static ResourceKey<StructureProcessorList> createKey(String id) {
        return ResourceKey.create(Registries.PROCESSOR_LIST, ResourceLocation.withDefaultNamespace(id));
    }

    private static void register(
        BootstrapContext<StructureProcessorList> processorListRegisterable, ResourceKey<StructureProcessorList> key, List<StructureProcessor> processors
    ) {
        processorListRegisterable.register(key, new StructureProcessorList(processors));
    }

    public static void bootstrap(BootstrapContext<StructureProcessorList> processorListRegisterable) {
        HolderGetter<Block> holderGetter = processorListRegisterable.lookup(Registries.BLOCK);
        ...
        register(processorListRegisterable, OUTPOST_ROT, ImmutableList.of(new BlockRotProcessor(0.05F)));
        register(
            processorListRegisterable,
            BOTTOM_RAMPART,
            ImmutableList.of(
        ...
        register(
            processorListRegisterable,
            FOSSIL_ROT,
            ImmutableList.of(new BlockRotProcessor(0.9F), new ProtectedBlockProcessor(BlockTags.FEATURES_CANNOT_REPLACE))
        );
        register(
            processorListRegisterable,
            FOSSIL_COAL,
            ImmutableList.of(new BlockRotProcessor(0.1F), new ProtectedBlockProcessor(BlockTags.FEATURES_CANNOT_REPLACE))
        );
        register(
            processorListRegisterable,
            FOSSIL_DIAMONDS,
        ...
        register(
            ...
            List.of(trailsArchyLootProcessor(BuiltInLootTables.TRAIL_RUINS_ARCHAEOLOGY_COMMON, 2))
        );
        register(
            processorListRegisterable,
