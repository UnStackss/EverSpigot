...
public class MiscOverworldFeatures {
    ...
    public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> featureRegisterable) {
        FeatureUtils.register(featureRegisterable, ICE_SPIKE, Feature.ICE_SPIKE);
        ...
        FeatureUtils.register(featureRegisterable, FOREST_ROCK, Feature.FOREST_ROCK, new BlockStateConfiguration(Blocks.MOSSY_COBBLESTONE.defaultBlockState()));
        FeatureUtils.register(featureRegisterable, ICEBERG_PACKED, Feature.ICEBERG, new BlockStateConfiguration(Blocks.PACKED_ICE.defaultBlockState()));
        FeatureUtils.register(featureRegisterable, ICEBERG_BLUE, Feature.ICEBERG, new BlockStateConfiguration(Blocks.BLUE_ICE.defaultBlockState()));
        FeatureUtils.register(featureRegisterable, BLUE_ICE, Feature.BLUE_ICE);
        FeatureUtils.register(
            featureRegisterable,
            LAKE_LAVA,
            Feature.LAKE,
        ...
        FeatureUtils.register(featureRegisterable, FREEZE_TOP_LAYER, Feature.FREEZE_TOP_LAYER);
        FeatureUtils.register(
            featureRegisterable,
            DISK_GRASS,
            Feature.DISK,
        ...
        FeatureUtils.register(featureRegisterable, BONUS_CHEST, Feature.BONUS_CHEST);
        FeatureUtils.register(featureRegisterable, VOID_START_PLATFORM, Feature.VOID_START_PLATFORM);
        FeatureUtils.register(featureRegisterable, DESERT_WELL, Feature.DESERT_WELL);
        FeatureUtils.register(
            featureRegisterable,
