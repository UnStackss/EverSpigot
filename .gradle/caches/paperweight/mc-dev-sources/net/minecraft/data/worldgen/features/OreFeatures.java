...
public class OreFeatures {
    ...
    public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> featureRegisterable) {
        ...
        List<OreConfiguration.TargetBlockState> list6 = List.of(
            OreConfiguration.target(ruleTest2, Blocks.COAL_ORE.defaultBlockState()),
            OreConfiguration.target(ruleTest3, Blocks.DEEPSLATE_COAL_ORE.defaultBlockState())
        );
        FeatureUtils.register(featureRegisterable, ORE_MAGMA, Feature.ORE, new OreConfiguration(ruleTest4, Blocks.MAGMA_BLOCK.defaultBlockState(), 33));
        FeatureUtils.register(featureRegisterable, ORE_SOUL_SAND, Feature.ORE, new OreConfiguration(ruleTest4, Blocks.SOUL_SAND.defaultBlockState(), 12));
        FeatureUtils.register(
            featureRegisterable, ORE_NETHER_GOLD, Feature.ORE, new OreConfiguration(ruleTest4, Blocks.NETHER_GOLD_ORE.defaultBlockState(), 10)
        );
        FeatureUtils.register(featureRegisterable, ORE_QUARTZ, Feature.ORE, new OreConfiguration(ruleTest4, Blocks.NETHER_QUARTZ_ORE.defaultBlockState(), 14));
        FeatureUtils.register(featureRegisterable, ORE_GRAVEL_NETHER, Feature.ORE, new OreConfiguration(ruleTest4, Blocks.GRAVEL.defaultBlockState(), 33));
        FeatureUtils.register(featureRegisterable, ORE_BLACKSTONE, Feature.ORE, new OreConfiguration(ruleTest4, Blocks.BLACKSTONE.defaultBlockState(), 33));
        FeatureUtils.register(featureRegisterable, ORE_DIRT, Feature.ORE, new OreConfiguration(ruleTest, Blocks.DIRT.defaultBlockState(), 33));
        FeatureUtils.register(featureRegisterable, ORE_GRAVEL, Feature.ORE, new OreConfiguration(ruleTest, Blocks.GRAVEL.defaultBlockState(), 33));
        FeatureUtils.register(featureRegisterable, ORE_GRANITE, Feature.ORE, new OreConfiguration(ruleTest, Blocks.GRANITE.defaultBlockState(), 64));
        FeatureUtils.register(featureRegisterable, ORE_DIORITE, Feature.ORE, new OreConfiguration(ruleTest, Blocks.DIORITE.defaultBlockState(), 64));
        FeatureUtils.register(featureRegisterable, ORE_ANDESITE, Feature.ORE, new OreConfiguration(ruleTest, Blocks.ANDESITE.defaultBlockState(), 64));
        FeatureUtils.register(featureRegisterable, ORE_TUFF, Feature.ORE, new OreConfiguration(ruleTest, Blocks.TUFF.defaultBlockState(), 64));
        FeatureUtils.register(featureRegisterable, ORE_COAL, Feature.ORE, new OreConfiguration(list6, 17));
        FeatureUtils.register(featureRegisterable, ORE_COAL_BURIED, Feature.ORE, new OreConfiguration(list6, 17, 0.5F));
        FeatureUtils.register(featureRegisterable, ORE_IRON, Feature.ORE, new OreConfiguration(list, 9));
        FeatureUtils.register(featureRegisterable, ORE_IRON_SMALL, Feature.ORE, new OreConfiguration(list, 4));
        FeatureUtils.register(featureRegisterable, ORE_GOLD, Feature.ORE, new OreConfiguration(list2, 9));
        FeatureUtils.register(featureRegisterable, ORE_GOLD_BURIED, Feature.ORE, new OreConfiguration(list2, 9, 0.5F));
        FeatureUtils.register(
            featureRegisterable,
            ORE_REDSTONE,
            Feature.ORE,
        ...
        FeatureUtils.register(featureRegisterable, ORE_DIAMOND_SMALL, Feature.ORE, new OreConfiguration(list3, 4, 0.5F));
        FeatureUtils.register(featureRegisterable, ORE_DIAMOND_LARGE, Feature.ORE, new OreConfiguration(list3, 12, 0.7F));
        FeatureUtils.register(featureRegisterable, ORE_DIAMOND_BURIED, Feature.ORE, new OreConfiguration(list3, 8, 1.0F));
        FeatureUtils.register(featureRegisterable, ORE_DIAMOND_MEDIUM, Feature.ORE, new OreConfiguration(list3, 8, 0.5F));
        FeatureUtils.register(featureRegisterable, ORE_LAPIS, Feature.ORE, new OreConfiguration(list4, 7));
        FeatureUtils.register(featureRegisterable, ORE_LAPIS_BURIED, Feature.ORE, new OreConfiguration(list4, 7, 1.0F));
        FeatureUtils.register(
            featureRegisterable,
            ORE_INFESTED,
            Feature.ORE,
        ...
        FeatureUtils.register(
            ...
            new OreConfiguration(ruleTest5, Blocks.ANCIENT_DEBRIS.defaultBlockState(), 3, 1.0F)
        );
        FeatureUtils.register(
            featureRegisterable,
            ORE_ANCIENT_DEBRIS_SMALL,
            Feature.SCATTERED_ORE,
            new OreConfiguration(ruleTest5, Blocks.ANCIENT_DEBRIS.defaultBlockState(), 2, 1.0F)
        );
        FeatureUtils.register(featureRegisterable, ORE_COPPPER_SMALL, Feature.ORE, new OreConfiguration(list5, 10));
        FeatureUtils.register(featureRegisterable, ORE_COPPER_LARGE, Feature.ORE, new OreConfiguration(list5, 20));
        FeatureUtils.register(featureRegisterable, ORE_CLAY, Feature.ORE, new OreConfiguration(ruleTest, Blocks.CLAY.defaultBlockState(), 33));
    }
}
