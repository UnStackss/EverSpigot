...
public class VanillaBlockLoot extends BlockLootSubProvider {
    ...
    public VanillaBlockLoot(HolderLookup.Provider registryLookup) {
        super(EXPLOSION_RESISTANT, FeatureFlags.REGISTRY.allFlags(), registryLookup);
    }
    ...
    protected void generate() {
                            ...
                            .add(
                                (LootPoolEntryContainer.Builder<?>)this.applyExplosionDecay(
                                    ...
                                    LootItem.lootTableItem(block)
                                        .apply(
                                            List.of(2, 3, 4),
                                            pickles -> SetItemCountFunction.setCount(ConstantValue.exactly((float)pickles.intValue()))
                                                    .when(
                                                        LootItemBlockStatePropertyCondition.hasBlockStateProperties(block)
                                                            .setProperties(
                                                                StatePropertiesPredicate.Builder.properties()
                                                                    .hasProperty(SeaPickleBlock.PICKLES, pickles.intValue())
                                                            )
                                                    )
                                        )
                                )
        ...
        this.add(
            ...
            block -> LootTable.lootTable()
                    .withPool(
                        LootPool.lootPool().add((LootPoolEntryContainer.Builder<?>)this.applyExplosionDecay(block, LootItem.lootTableItem(Items.COMPOSTER)))
                    )
                    .withPool(
                        LootPool.lootPool()
        ...
        this.add(
            ...
            this.applyExplosionDecay(
                Blocks.MANGROVE_PROPAGULE,
                LootTable.lootTable().withPool(LootPool.lootPool().when(builder4).add(LootItem.lootTableItem(Items.MANGROVE_PROPAGULE)))
            )
        );
        this.add(
        ...
        this.add(Blocks.NETHER_SPROUTS, block -> BlockLootSubProvider.createShearsOnlyDrop(block));
        this.add(Blocks.SEAGRASS, block -> BlockLootSubProvider.createShearsOnlyDrop(block));
        this.add(Blocks.VINE, block -> BlockLootSubProvider.createShearsOnlyDrop(block));
        this.add(Blocks.GLOW_LICHEN, block -> this.createMultifaceBlockDrops(block, HAS_SHEARS));
        this.add(Blocks.HANGING_ROOTS, block -> BlockLootSubProvider.createShearsOnlyDrop(block));
        this.add(Blocks.SMALL_DRIPLEAF, block -> BlockLootSubProvider.createShearsOnlyDrop(block));
                                            ...
                                            integer -> LootItem.lootTableItem(Items.SNOWBALL)
                                                    .when(
                                                        LootItemBlockStatePropertyCondition.hasBlockStateProperties(block)
                                                            .setProperties(
                                                                StatePropertiesPredicate.Builder.properties()
                                                                    .hasProperty(SnowLayerBlock.LAYERS, integer.intValue())
                                                            )
                                                    )
            ...
            block -> this.createSilkTouchDispatchTable(
                    ...
                    this.applyExplosionCondition(
                        ...
                        LootItem.lootTableItem(Items.FLINT)
                            .when(
                                BonusLevelTableCondition.bonusLevelFlatChance(registryLookup.getOrThrow(Enchantments.FORTUNE), 0.1F, 0.14285715F, 0.25F, 1.0F)
                            )
                    ...
                    LootPool.lootPool()
                        .add(
                            AlternativesEntry.alternatives(
                                ...
                                age -> {
                                    LootItemBlockStatePropertyCondition.Builder builder = LootItemBlockStatePropertyCondition.hasBlockStateProperties(
                                            Blocks.PITCHER_CROP
                                        )
                                        .setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(DoublePlantBlock.HALF, DoubleBlockHalf.LOWER));
                                    LootItemBlockStatePropertyCondition.Builder builder2 = LootItemBlockStatePropertyCondition.hasBlockStateProperties(
                                            Blocks.PITCHER_CROP
                                        )
