...
public class VanillaHusbandryAdvancements implements AdvancementSubProvider {
    ...
    public void generate(HolderLookup.Provider lookup, Consumer<AdvancementHolder> exporter) {
        HolderLookup.RegistryLookup<Enchantment> registryLookup = lookup.lookupOrThrow(Registries.ENCHANTMENT);
        ...
        AdvancementHolder advancementHolder2 = Advancement.Builder.advancement()
            ...
            .save(exporter, "husbandry/plant_seed");
        AdvancementHolder advancementHolder3 = Advancement.Builder.advancement()
            ...
            .save(exporter, "husbandry/breed_an_animal");
        createBreedAllAnimalsAdvancement(advancementHolder3, exporter, BREEDABLE_ANIMALS.stream(), INDIRECTLY_BREEDABLE_ANIMALS.stream());
        addFood(Advancement.Builder.advancement())
            ...
            .save(exporter, "husbandry/balanced_diet");
        Advancement.Builder.advancement()
            ...
            .save(exporter, "husbandry/obtain_netherite_hoe");
        AdvancementHolder advancementHolder4 = Advancement.Builder.advancement()
            ...
            .save(exporter, "husbandry/tame_an_animal");
        AdvancementHolder advancementHolder5 = addFish(Advancement.Builder.advancement())
            ...
            .save(exporter, "husbandry/fishy_business");
        AdvancementHolder advancementHolder6 = addFishBuckets(Advancement.Builder.advancement())
            ...
            .save(exporter, "husbandry/tactical_fishing");
        AdvancementHolder advancementHolder7 = Advancement.Builder.advancement()
            ...
            .save(exporter, "husbandry/axolotl_in_a_bucket");
        Advancement.Builder.advancement()
            ...
            .save(exporter, "husbandry/kill_axolotl_target");
        addCatVariants(Advancement.Builder.advancement())
            ...
            .save(exporter, "husbandry/complete_catalogue");
        addTamedWolfVariants(Advancement.Builder.advancement(), lookup)
            .parent(advancementHolder4)
            .display(
                Items.BONE,
            ...
            .rewards(AdvancementRewards.Builder.experience(50))
            .save(exporter, "husbandry/whole_pack");
        AdvancementHolder advancementHolder8 = Advancement.Builder.advancement()
            ...
            .save(exporter, "husbandry/safely_harvest_honey");
        AdvancementHolder advancementHolder9 = Advancement.Builder.advancement()
            ...
            .save(exporter, "husbandry/wax_on");
        Advancement.Builder.advancement()
            ...
            .save(exporter, "husbandry/wax_off");
        AdvancementHolder advancementHolder10 = Advancement.Builder.advancement()
            ...
            .save(exporter, "husbandry/tadpole_in_a_bucket");
        AdvancementHolder advancementHolder11 = addLeashedFrogVariants(Advancement.Builder.advancement())
            ...
            .save(exporter, "husbandry/leash_all_frog_variants");
        Advancement.Builder.advancement()
        ...
        Advancement.Builder.advancement()
            ...
            .save(exporter, "husbandry/silk_touch_nest");
        Advancement.Builder.advancement()
            .parent(advancementHolder)
            .display(
                Items.OAK_BOAT,
            ...
            .save(exporter, "husbandry/ride_a_boat_with_a_goat");
        Advancement.Builder.advancement()
            .parent(advancementHolder)
            .display(
                Items.GLOW_INK_SAC,
            ...
            .save(exporter, "husbandry/make_a_sign_glow");
        AdvancementHolder advancementHolder12 = Advancement.Builder.advancement()
            ...
            .save(exporter, "husbandry/allay_deliver_item_to_player");
        Advancement.Builder.advancement()
            ...
            .save(exporter, "husbandry/allay_deliver_cake_to_note_block");
        AdvancementHolder advancementHolder13 = Advancement.Builder.advancement()
            ...
            .save(exporter, "husbandry/obtain_sniffer_egg");
        AdvancementHolder advancementHolder14 = Advancement.Builder.advancement()
            ...
            .save(exporter, "husbandry/feed_snifflet");
        Advancement.Builder.advancement()
            ...
            .addCriterion("torchflower", ItemUsedOnLocationTrigger.TriggerInstance.placedBlock(Blocks.TORCHFLOWER_CROP))
            .addCriterion("pitcher_pod", ItemUsedOnLocationTrigger.TriggerInstance.placedBlock(Blocks.PITCHER_CROP))
            .save(exporter, "husbandry/plant_any_sniffer_seed");
        Advancement.Builder.advancement()
            .parent(advancementHolder4)
            .display(
                Items.SHEARS,
            ...
            .save(exporter, "husbandry/remove_wolf_armor");
        Advancement.Builder.advancement()
            .parent(advancementHolder4)
            .display(
                Items.WOLF_ARMOR,
            ...
            .save(exporter, "husbandry/repair_wolf_armor");
    }

    public static AdvancementHolder createBreedAllAnimalsAdvancement(
        AdvancementHolder parent, Consumer<AdvancementHolder> exporter, Stream<EntityType<?>> breedableAnimals, Stream<EntityType<?>> eggLayingAnimals
    ) {
        return addBreedable(Advancement.Builder.advancement(), breedableAnimals, eggLayingAnimals)
            .parent(parent)
            .display(
                Items.GOLDEN_CARROT,
            ...
            .rewards(AdvancementRewards.Builder.experience(100))
            .save(exporter, "husbandry/bred_all_animals");
    }
    ...
    private static Advancement.Builder addLeashedFrogVariants(Advancement.Builder builder) {
        BuiltInRegistries.FROG_VARIANT
            .holders()
            .forEach(
                variant -> builder.addCriterion(
                        variant.key().location().toString(),
                        PlayerInteractTrigger.TriggerInstance.itemUsedOnEntity(
                            ItemPredicate.Builder.item().of(Items.LEAD),
                            Optional.of(
                                EntityPredicate.wrap(
                                    EntityPredicate.Builder.entity().of(EntityType.FROG).subPredicate(EntitySubPredicates.frogVariant(variant))
                                )
                            )
                        )
                    )
    ...
    private static Advancement.Builder addBreedable(
        ...
        breedableAnimals.forEach(
            type -> advancementBuilder.addCriterion(
                    EntityType.getKey((EntityType<?>)type).toString(),
                    BredAnimalsTrigger.TriggerInstance.bredAnimals(EntityPredicate.Builder.entity().of((EntityType<?>)type))
                )
        );
        eggLayingAnimals.forEach(
            type -> advancementBuilder.addCriterion(
                    ...
                    BredAnimalsTrigger.TriggerInstance.bredAnimals(
                        Optional.of(EntityPredicate.Builder.entity().of((EntityType<?>)type).build()),
                        Optional.of(EntityPredicate.Builder.entity().of((EntityType<?>)type).build()),
                        Optional.empty()
                    )
                )
        ...
        BuiltInRegistries.CAT_VARIANT
            ...
            .forEach(
                entry -> builder.addCriterion(
                        entry.key().location().toString(),
                        TameAnimalTrigger.TriggerInstance.tamedAnimal(EntityPredicate.Builder.entity().subPredicate(EntitySubPredicates.catVariant(entry)))
                    )
            );
        return builder;
    }

    private static Advancement.Builder addTamedWolfVariants(Advancement.Builder builder, HolderLookup.Provider registryLookup) {
        HolderLookup.RegistryLookup<WolfVariant> registryLookup2 = registryLookup.lookupOrThrow(Registries.WOLF_VARIANT);
        registryLookup2.listElementIds()
            .sorted(Comparator.comparing(ResourceKey::location))
            .forEach(
                key -> {
                    Holder<WolfVariant> holder = registryLookup2.getOrThrow((ResourceKey<WolfVariant>)key);
                    builder.addCriterion(
