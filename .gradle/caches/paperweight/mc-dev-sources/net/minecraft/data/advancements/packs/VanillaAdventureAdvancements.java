...
public class VanillaAdventureAdvancements implements AdvancementSubProvider {
    ...
    private static Criterion<LightningStrikeTrigger.TriggerInstance> fireCountAndBystander(MinMaxBounds.Ints range, Optional<EntityPredicate> entity) {
        return LightningStrikeTrigger.TriggerInstance.lightningStrike(
            Optional.of(
                EntityPredicate.Builder.entity()
                    ...
                    .subPredicate(LightningBoltPredicate.blockSetOnFire(range))
                    .build()
            ),
            entity
        );
    ...
    public void generate(HolderLookup.Provider lookup, Consumer<AdvancementHolder> exporter) {
        ...
        AdvancementHolder advancementHolder2 = Advancement.Builder.advancement()
            ...
            .save(exporter, "adventure/sleep_in_bed");
        createAdventuringTime(lookup, exporter, advancementHolder2, MultiNoiseBiomeSourceParameterList.Preset.OVERWORLD);
        ...
        Advancement.Builder.advancement()
            ...
            .save(exporter, "adventure/trade_at_world_height");
        AdvancementHolder advancementHolder4 = createMonsterHunterAdvancement(advancementHolder, exporter, MOBS_TO_KILL);
        AdvancementHolder advancementHolder5 = Advancement.Builder.advancement()
            ...
            .save(exporter, "adventure/shoot_arrow");
        AdvancementHolder advancementHolder6 = Advancement.Builder.advancement()
            ...
            .save(exporter, "adventure/throw_trident");
        Advancement.Builder.advancement()
            ...
            .save(exporter, "adventure/very_very_frightening");
        Advancement.Builder.advancement()
            .parent(advancementHolder3)
            .display(
            ...
            .save(exporter, "adventure/summon_iron_golem");
        Advancement.Builder.advancement()
            ...
            .save(exporter, "adventure/sniper_duel");
        Advancement.Builder.advancement()
            .parent(advancementHolder4)
            .display(
            ...
            .save(exporter, "adventure/totem_of_undying");
        AdvancementHolder advancementHolder7 = Advancement.Builder.advancement()
            ...
            .save(exporter, "adventure/ol_betsy");
        Advancement.Builder.advancement()
            ...
            .save(exporter, "adventure/whos_the_pillager_now");
        Advancement.Builder.advancement()
            .parent(advancementHolder7)
            .display(
                Items.CROSSBOW,
            ...
            .save(exporter, "adventure/two_birds_one_arrow");
        Advancement.Builder.advancement()
            .parent(advancementHolder7)
            .display(
                Items.CROSSBOW,
            ...
            .save(exporter, "adventure/arbalistic");
        HolderLookup.RegistryLookup<BannerPattern> registryLookup = lookup.lookupOrThrow(Registries.BANNER_PATTERN);
        AdvancementHolder advancementHolder8 = Advancement.Builder.advancement()
            ...
            .save(exporter, "adventure/voluntary_exile");
        Advancement.Builder.advancement()
            ...
            .save(exporter, "adventure/hero_of_the_village");
        Advancement.Builder.advancement()
            .parent(advancementHolder)
            .display(
            ...
            .save(exporter, "adventure/honey_block_slide");
        Advancement.Builder.advancement()
            .parent(advancementHolder5)
            .display(
            ...
            .save(exporter, "adventure/bullseye");
        Advancement.Builder.advancement()
            ...
            .save(exporter, "adventure/walk_on_powder_snow_with_leather_boots");
        Advancement.Builder.advancement()
            .parent(advancementHolder)
            .display(
                Items.LIGHTNING_ROD,
            ...
            .save(exporter, "adventure/lightning_rod_with_villager_no_fire");
        AdvancementHolder advancementHolder9 = Advancement.Builder.advancement()
            ...
            .save(exporter, "adventure/spyglass_at_parrot");
        AdvancementHolder advancementHolder10 = Advancement.Builder.advancement()
            ...
            .save(exporter, "adventure/spyglass_at_ghast");
        Advancement.Builder.advancement()
            .parent(advancementHolder2)
            .display(
                Items.JUKEBOX,
            ...
            .addCriterion(
                ...
                ItemUsedOnLocationTrigger.TriggerInstance.itemUsedOnBlock(
                    LocationPredicate.Builder.location()
                        .setBiomes(HolderSet.direct(lookup.lookupOrThrow(Registries.BIOME).getOrThrow(Biomes.MEADOW)))
            ...
            .save(exporter, "adventure/play_jukebox_in_meadows");
        Advancement.Builder.advancement()
            ...
            .save(exporter, "adventure/spyglass_at_dragon");
        Advancement.Builder.advancement()
            .parent(advancementHolder)
            .display(
                Items.WATER_BUCKET,
            ...
            .save(exporter, "adventure/fall_from_world_height");
        Advancement.Builder.advancement()
            .parent(advancementHolder4)
            .display(
            ...
            .save(exporter, "adventure/kill_mob_near_sculk_catalyst");
        Advancement.Builder.advancement()
            .parent(advancementHolder)
            .display(
                Blocks.SCULK_SENSOR,
            ...
            .save(exporter, "adventure/avoid_vibration");
        AdvancementHolder advancementHolder11 = respectingTheRemnantsCriterions(Advancement.Builder.advancement())
            ...
            .save(exporter, "adventure/salvage_sherd");
        Advancement.Builder.advancement()
            ...
            .save(exporter, "adventure/craft_decorated_pot_using_only_sherds");
        AdvancementHolder advancementHolder12 = craftingANewLook(Advancement.Builder.advancement())
            ...
            .save(exporter, "adventure/trim_with_any_armor_pattern");
        smithingWithStyle(Advancement.Builder.advancement())
            ...
            .save(exporter, "adventure/trim_with_all_exclusive_armor_patterns");
        Advancement.Builder.advancement()
            .parent(advancementHolder)
            .display(
            ...
            .save(exporter, "adventure/read_power_of_chiseled_bookshelf");
        Advancement.Builder.advancement()
            .parent(advancementHolder)
            .display(
            ...
            .save(exporter, "adventure/brush_armadillo");
        AdvancementHolder advancementHolder13 = Advancement.Builder.advancement()
            ...
            .addCriterion(
                ...
                PlayerTrigger.TriggerInstance.located(
                    LocationPredicate.Builder.inStructure(lookup.lookupOrThrow(Registries.STRUCTURE).getOrThrow(BuiltinStructures.TRIAL_CHAMBERS))
                )
            )
            .save(exporter, "adventure/minecraft_trials_edition");
        Advancement.Builder.advancement()
            ...
            .save(exporter, "adventure/lighten_up");
        AdvancementHolder advancementHolder14 = Advancement.Builder.advancement()
            ...
            .save(exporter, "adventure/under_lock_and_key");
        Advancement.Builder.advancement()
            ...
            .save(exporter, "adventure/revaulting");
        Advancement.Builder.advancement()
            .parent(advancementHolder13)
            .display(
                Items.WIND_CHARGE,
            ...
            .save(exporter, "adventure/blowback");
        Advancement.Builder.advancement()
            .parent(advancementHolder)
            .display(
                Items.CRAFTER,
            ...
            .save(exporter, "adventure/crafters_crafting_crafters");
        Advancement.Builder.advancement()
            .parent(advancementHolder13)
            .display(
                Items.WIND_CHARGE,
            ...
            .save(exporter, "adventure/who_needs_rockets");
        Advancement.Builder.advancement()
            .parent(advancementHolder13)
            .display(
                Items.MACE,
            ...
            .save(exporter, "adventure/overoverkill");
    }

    public static AdvancementHolder createMonsterHunterAdvancement(AdvancementHolder parent, Consumer<AdvancementHolder> exporter, List<EntityType<?>> monsters) {
        AdvancementHolder advancementHolder = addMobsToKill(Advancement.Builder.advancement(), monsters)
            .parent(parent)
            .display(
                Items.IRON_SWORD,
            ...
            .requirements(AdvancementRequirements.Strategy.OR)
            .save(exporter, "adventure/kill_a_mob");
        addMobsToKill(Advancement.Builder.advancement(), monsters)
            .parent(advancementHolder)
            .display(
                Items.DIAMOND_SWORD,
            ...
            .rewards(AdvancementRewards.Builder.experience(100))
            .save(exporter, "adventure/kill_all_mobs");
        return advancementHolder;
    }

    private static Criterion<ItemUsedOnLocationTrigger.TriggerInstance> placedBlockReadByComparator(Block block) {
        LootItemCondition.Builder[] builders = ComparatorBlock.FACING.getPossibleValues().stream().map(facing -> {
            StatePropertiesPredicate.Builder builder = StatePropertiesPredicate.Builder.properties().hasProperty(ComparatorBlock.FACING, facing);
            BlockPredicate.Builder builder2 = BlockPredicate.Builder.block().of(Blocks.COMPARATOR).setProperties(builder);
            return LocationCheck.checkLocation(LocationPredicate.Builder.location().setBlock(builder2), new BlockPos(facing.getOpposite().getNormal()));
    ...
    private static Criterion<ItemUsedOnLocationTrigger.TriggerInstance> placedComparatorReadingBlock(Block block) {
        LootItemCondition.Builder[] builders = ComparatorBlock.FACING
            ...
            .map(
                facing -> {
                    StatePropertiesPredicate.Builder builder = StatePropertiesPredicate.Builder.properties().hasProperty(ComparatorBlock.FACING, facing);
                    LootItemBlockStatePropertyCondition.Builder builder2 = new LootItemBlockStatePropertyCondition.Builder(Blocks.COMPARATOR)
                        .setProperties(builder);
                    LootItemCondition.Builder builder3 = LocationCheck.checkLocation(
                        LocationPredicate.Builder.location().setBlock(BlockPredicate.Builder.block().of(block)), new BlockPos(facing.getNormal())
                    );
    ...
    private static Advancement.Builder smithingWithStyle(Advancement.Builder builder) {
        ...
        VanillaRecipeProvider.smithingTrims()
            ...
            .forEach(templatex -> builder.addCriterion("armor_trimmed_" + templatex.id(), RecipeCraftedTrigger.TriggerInstance.craftedItem(templatex.id())));
        return builder;
    }
    ...
    private static Advancement.Builder craftingANewLook(Advancement.Builder builder) {
        ...
        VanillaRecipeProvider.smithingTrims()
            ...
            .forEach(template -> builder.addCriterion("armor_trimmed_" + template, RecipeCraftedTrigger.TriggerInstance.craftedItem(template)));
        return builder;
    }
    ...
    protected static void createAdventuringTime(
        ...
        addBiomes(Advancement.Builder.advancement(), registryLookup, biomeSourceListPreset.usedBiomes().toList())
            .parent(parent)
            .display(
                Items.DIAMOND_BOOTS,
            ...
            .save(exporter, "adventure/adventuring_time");
    }

    private static Advancement.Builder addMobsToKill(Advancement.Builder builder, List<EntityType<?>> entityTypes) {
        entityTypes.forEach(
            type -> builder.addCriterion(
                    BuiltInRegistries.ENTITY_TYPE.getKey((EntityType<?>)type).toString(),
                    KilledTrigger.TriggerInstance.playerKilledEntity(EntityPredicate.Builder.entity().of((EntityType<?>)type))
                )
        );
        return builder;
    }

    protected static Advancement.Builder addBiomes(Advancement.Builder builder, HolderLookup.Provider registryLookup, List<ResourceKey<Biome>> biomes) {
        HolderGetter<Biome> holderGetter = registryLookup.lookupOrThrow(Registries.BIOME);
