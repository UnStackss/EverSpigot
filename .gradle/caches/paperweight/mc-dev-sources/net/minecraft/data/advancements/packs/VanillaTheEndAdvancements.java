...
public class VanillaTheEndAdvancements implements AdvancementSubProvider {
    ...
    public void generate(HolderLookup.Provider lookup, Consumer<AdvancementHolder> exporter) {
        ...
        AdvancementHolder advancementHolder3 = Advancement.Builder.advancement()
            ...
            .save(exporter, "end/enter_end_gateway");
        Advancement.Builder.advancement()
            ...
            .save(exporter, "end/respawn_dragon");
        AdvancementHolder advancementHolder4 = Advancement.Builder.advancement()
            ...
            .addCriterion(
                ...
                PlayerTrigger.TriggerInstance.located(
                    LocationPredicate.Builder.inStructure(lookup.lookupOrThrow(Registries.STRUCTURE).getOrThrow(BuiltinStructures.END_CITY))
                )
            )
            .save(exporter, "end/find_end_city");
        Advancement.Builder.advancement()
            .parent(advancementHolder2)
            .display(
                Items.DRAGON_BREATH,
            ...
            .save(exporter, "end/dragon_breath");
        Advancement.Builder.advancement()
