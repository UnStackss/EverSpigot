...
public class VanillaNetherAdvancements implements AdvancementSubProvider {
    ...
    public void generate(HolderLookup.Provider lookup, Consumer<AdvancementHolder> exporter) {
        ...
        AdvancementHolder advancementHolder2 = Advancement.Builder.advancement()
            ...
            .save(exporter, "nether/return_to_sender");
        AdvancementHolder advancementHolder3 = Advancement.Builder.advancement()
            ...
            .addCriterion(
                ...
                PlayerTrigger.TriggerInstance.located(
                    LocationPredicate.Builder.inStructure(lookup.lookupOrThrow(Registries.STRUCTURE).getOrThrow(BuiltinStructures.FORTRESS))
                )
            )
            .save(exporter, "nether/find_fortress");
        Advancement.Builder.advancement()
            ...
            .save(exporter, "nether/fast_travel");
        Advancement.Builder.advancement()
            ...
            .save(exporter, "nether/uneasy_alliance");
        AdvancementHolder advancementHolder4 = Advancement.Builder.advancement()
            ...
            .save(exporter, "nether/get_wither_skull");
        AdvancementHolder advancementHolder5 = Advancement.Builder.advancement()
            ...
            .save(exporter, "nether/summon_wither");
        AdvancementHolder advancementHolder6 = Advancement.Builder.advancement()
            ...
            .save(exporter, "nether/obtain_blaze_rod");
        AdvancementHolder advancementHolder7 = Advancement.Builder.advancement()
            ...
            .save(exporter, "nether/create_beacon");
        Advancement.Builder.advancement()
            ...
            .save(exporter, "nether/create_full_beacon");
        AdvancementHolder advancementHolder8 = Advancement.Builder.advancement()
            ...
            .save(exporter, "nether/brew_potion");
        AdvancementHolder advancementHolder9 = Advancement.Builder.advancement()
            ...
            .save(exporter, "nether/all_potions");
        Advancement.Builder.advancement()
            ...
            .save(exporter, "nether/all_effects");
        AdvancementHolder advancementHolder10 = Advancement.Builder.advancement()
            ...
            .save(exporter, "nether/obtain_ancient_debris");
        Advancement.Builder.advancement()
            ...
            .save(exporter, "nether/netherite_armor");
        Advancement.Builder.advancement()
            .parent(advancementHolder10)
            .display(
                Items.LODESTONE,
            ...
            .save(exporter, "nether/use_lodestone");
        AdvancementHolder advancementHolder11 = Advancement.Builder.advancement()
            ...
            .save(exporter, "nether/obtain_crying_obsidian");
        Advancement.Builder.advancement()
            ...
            .save(exporter, "nether/charge_respawn_anchor");
        AdvancementHolder advancementHolder12 = Advancement.Builder.advancement()
            ...
            .save(exporter, "nether/ride_strider");
        Advancement.Builder.advancement()
            ...
            .save(exporter, "nether/ride_strider_in_overworld_lava");
        VanillaAdventureAdvancements.addBiomes(
                Advancement.Builder.advancement(), lookup, MultiNoiseBiomeSourceParameterList.Preset.NETHER.usedBiomes().toList()
            )
            .parent(advancementHolder12)
            .display(
            ...
            .save(exporter, "nether/explore_nether");
        AdvancementHolder advancementHolder13 = Advancement.Builder.advancement()
            ...
            .addCriterion(
                "bastion",
                PlayerTrigger.TriggerInstance.located(
                    LocationPredicate.Builder.inStructure(lookup.lookupOrThrow(Registries.STRUCTURE).getOrThrow(BuiltinStructures.BASTION_REMNANT))
                )
            )
            .save(exporter, "nether/find_bastion");
        Advancement.Builder.advancement()
            ...
            .save(exporter, "nether/loot_bastion");
        Advancement.Builder.advancement()
            .parent(advancementHolder)
            .requirements(AdvancementRequirements.Strategy.OR)
            .display(
            ...
            .save(exporter, "nether/distract_piglin");
    }
}
