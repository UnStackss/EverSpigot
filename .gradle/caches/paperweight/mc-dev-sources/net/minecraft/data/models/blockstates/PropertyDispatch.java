...
public abstract class PropertyDispatch {
    ...
    private void verifyComplete() {
        ...
        for (Property<?> property : list) {
            stream = stream.flatMap(propertiesMap -> property.getAllValues().map(propertiesMap::extend));
        }

        List<Selector> list2 = stream.filter(propertiesMap -> !this.values.containsKey(propertiesMap)).collect(Collectors.toList());
        if (!list2.isEmpty()) {
    ...
    public static class C1<T1 extends Comparable<T1>> extends PropertyDispatch {
        ...
        public PropertyDispatch generate(Function<T1, Variant> variantFactory) {
            this.property1.getPossibleValues().forEach(value -> this.select((T1)value, variantFactory.apply((T1)value)));
            return this;
        }
    ...
    public static class C2<T1 extends Comparable<T1>, T2 extends Comparable<T2>> extends PropertyDispatch {
        ...
        public PropertyDispatch generate(BiFunction<T1, T2, Variant> variantFactory) {
            this.property1
                .getPossibleValues()
                .forEach(
                    firstValue -> this.property2
                            .getPossibleValues()
                            .forEach(secondValue -> this.select((T1)firstValue, (T2)secondValue, variantFactory.apply((T1)firstValue, (T2)secondValue)))
                );
            return this;
        }
        ...
        public PropertyDispatch generateList(BiFunction<T1, T2, List<Variant>> variantsFactory) {
            this.property1
                ...
                .forEach(
                    firstValue -> this.property2
                            .getPossibleValues()
                            .forEach(secondValue -> this.select((T1)firstValue, (T2)secondValue, variantsFactory.apply((T1)firstValue, (T2)secondValue)))
                );
            return this;
        }
    }
            ...
            this.property1
                ...
                .forEach(
                    firstValue -> this.property2
                            .getPossibleValues()
                            .forEach(
                                secondValue -> this.property3
                                        .getPossibleValues()
                                        .forEach(
                                            thirdValue -> this.select(
                                                    (T1)firstValue,
                                                    (T2)secondValue,
                                                    (T3)thirdValue,
                                                    variantFactory.apply((T1)firstValue, (T2)secondValue, (T3)thirdValue)
                                                )
                                        )
                            )
                );
    ...
    public static class C4<T1 extends Comparable<T1>, T2 extends Comparable<T2>, T3 extends Comparable<T3>, T4 extends Comparable<T4>> extends PropertyDispatch {
        ...
        public PropertyDispatch.C4<T1, T2, T3, T4> select(T1 firstValue, T2 secondValue, T3 thirdValue, T4 fourthValue, List<Variant> variants) {
            Selector selector = Selector.of(
                this.property1.value(firstValue), this.property2.value(secondValue), this.property3.value(thirdValue), this.property4.value(fourthValue)
            );
            this.putValue(selector, variants);
            return this;
        }
                    ...
                    firstValue -> this.property2
                            ...
                            .forEach(
                                secondValue -> this.property3
                                        .getPossibleValues()
                                        .forEach(
                                            thirdValue -> this.property4
                                                    .getPossibleValues()
                                                    .forEach(
                                                        fourthValue -> this.select(
                                                                (T1)firstValue,
                                                                (T2)secondValue,
                                                                (T3)thirdValue,
                                                                (T4)fourthValue,
    ...
    public static class C5<T1 extends Comparable<T1>, T2 extends Comparable<T2>, T3 extends Comparable<T3>, T4 extends Comparable<T4>, T5 extends Comparable<T5>>
        ...
        public PropertyDispatch.C5<T1, T2, T3, T4, T5> select(
            T1 firstValue, T2 secondValue, T3 thirdValue, T4 fourthValue, T5 fifthValue, List<Variant> variants
        ) {
            Selector selector = Selector.of(
                this.property1.value(firstValue),
                this.property2.value(secondValue),
                this.property3.value(thirdValue),
                this.property4.value(fourthValue),
                this.property5.value(fifthValue)
            );
            this.putValue(selector, variants);
            return this;
        }
                                ...
                                secondValue -> this.property3
                                        ...
                                        .forEach(
                                            thirdValue -> this.property4
                                                    .getPossibleValues()
                                                    .forEach(
                                                        fourthValue -> this.property5
                                                                .getPossibleValues()
                                                                .forEach(
                                                                    fifthValue -> this.select(
                                                                            (T1)firstValue,
                                                                            (T2)secondValue,
                                                                            (T3)thirdValue,
                                                                            (T4)fourthValue,
                                                                            (T5)fifthValue,
                                                                            variantFactory.apply(
                                                                                (T1)firstValue,
                                                                                (T2)secondValue,
                                                                                (T3)thirdValue,
                                                                                (T4)fourthValue,
