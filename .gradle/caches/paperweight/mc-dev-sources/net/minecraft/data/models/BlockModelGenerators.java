...
public class BlockModelGenerators {
    ...
    private void createTrialSpawner() {
        ...
        ResourceLocation resourceLocation5 = ModelTemplates.CUBE_BOTTOM_TOP_INNER_FACES
            .createWithSuffix(block, "_active_ominous", textureMapping5, this.modelOutput);
                            ...
                            .generate(
                                (spawnerState, ominous) -> {
                                    return switch (spawnerState) {
                                        ...
                                        .with(VariantProperties.MODEL, ominous ? resourceLocation4 : resourceLocation);
                                        case WAITING_FOR_PLAYERS, ACTIVE, WAITING_FOR_REWARD_EJECTION -> Variant.variant()
                                        .with(VariantProperties.MODEL, ominous ? resourceLocation5 : resourceLocation2);
                                        case EJECTING_REWARD -> Variant.variant()
                                        .with(VariantProperties.MODEL, ominous ? resourceLocation6 : resourceLocation3);
                                    };
                                }
                            )
                    )
    ...
    private void createVault() {
        ...
        this.blockStateOutput
            .accept(
                MultiVariantGenerator.multiVariant(block)
                    .with(createHorizontalFacingDispatch())
                    .with(PropertyDispatch.properties(VaultBlock.STATE, VaultBlock.OMINOUS).generate((vaultState, ominous) -> {
                        return switch (vaultState) {
                            case INACTIVE -> Variant.variant().with(VariantProperties.MODEL, ominous ? resourceLocation5 : resourceLocation);
                            case ACTIVE -> Variant.variant().with(VariantProperties.MODEL, ominous ? resourceLocation6 : resourceLocation2);
                            case UNLOCKING -> Variant.variant().with(VariantProperties.MODEL, ominous ? resourceLocation7 : resourceLocation3);
                            case EJECTING -> Variant.variant().with(VariantProperties.MODEL, ominous ? resourceLocation8 : resourceLocation4);
                        };
                    }))
            );
    }
    ...
    class BlockEntityModelGenerator {
        ...
        public BlockEntityModelGenerator(final ResourceLocation modelId, final Block block) {
    ...
    class BlockFamilyProvider {
        ...
        public BlockFamilyProvider(final TextureMapping textures) {
    ...
    class WoodProvider {
        ...
        public WoodProvider(final TextureMapping textures) {
