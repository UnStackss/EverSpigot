...
public class ModelTemplates {
    ...
    public static final ModelTemplate[] STEMS = IntStream.range(0, 8)
        .mapToObj(stage -> create("stem_growth" + stage, "_stage" + stage, TextureSlot.STEM))
    ...
    private static ModelTemplate createItem(String parent, TextureSlot... requiredTextureKeys) {
        return new ModelTemplate(Optional.of(ResourceLocation.withDefaultNamespace("item/" + parent)), Optional.empty(), requiredTextureKeys);
    }
