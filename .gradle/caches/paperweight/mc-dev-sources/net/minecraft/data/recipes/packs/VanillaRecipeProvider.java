...
public class VanillaRecipeProvider extends RecipeProvider {
    ...
    protected void buildRecipes(RecipeOutput exporter) {
        ...
        copySmithingTemplate(exporter, Items.FLOW_ARMOR_TRIM_SMITHING_TEMPLATE, Items.BREEZE_ROD);
        copySmithingTemplate(exporter, Items.BOLT_ARMOR_TRIM_SMITHING_TEMPLATE, Ingredient.of(Items.COPPER_BLOCK, Items.WAXED_COPPER_BLOCK));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, Items.MACE, 1)
            ...
            .save(exporter);
        doorBuilder(Blocks.COPPER_DOOR, Ingredient.of(Items.COPPER_INGOT)).unlockedBy(getHasName(Items.COPPER_INGOT), has(Items.COPPER_INGOT)).save(exporter);
    ...
    public static Stream<VanillaRecipeProvider.TrimTemplate> smithingTrims() {
        return Stream.of(
            ...
            .map(template -> new VanillaRecipeProvider.TrimTemplate(template, ResourceLocation.withDefaultNamespace(getItemName(template) + "_smithing_trim")));
    }
