...
public class SoundEvents {
    ...
    private static Holder<SoundEvent> register(ResourceLocation id, ResourceLocation soundId, float distanceToTravel) {
    ...
    private static Holder.Reference<SoundEvent> registerForHolder(String id) {
        return registerForHolder(ResourceLocation.withDefaultNamespace(id));
    }
    ...
    private static Holder.Reference<SoundEvent> registerForHolder(ResourceLocation id, ResourceLocation soundId) {
    ...
    private static ImmutableList<Holder.Reference<SoundEvent>> registerGoatHornSoundVariants() {
        return IntStream.range(0, 8).mapToObj(variant -> registerForHolder("item.goat_horn.sound." + variant)).collect(ImmutableList.toImmutableList());
    }
}
