...
public final class RecipeBookSettings {
    ...
    public RecipeBookSettings() {
        this(Util.make(Maps.newEnumMap(RecipeBookType.class), categoryOptions -> {
            for (RecipeBookType recipeBookType : RecipeBookType.values()) {
                categoryOptions.put(recipeBookType, new RecipeBookSettings.TypeSettings(false, false));
            }
        }));
    }
    ...
    static final class TypeSettings {
        ...
        public boolean equals(Object object) {
            return this == object
                || object instanceof RecipeBookSettings.TypeSettings typeSettings && this.open == typeSettings.open && this.filtering == typeSettings.filtering;
        }
