...
public class ServerboundSetCommandBlockPacket implements Packet<ServerGamePacketListener> {
    ...
    public ServerboundSetCommandBlockPacket(
        BlockPos pos, String command, CommandBlockEntity.Mode type, boolean trackOutput, boolean conditional, boolean alwaysActive
    ) {
        this.pos = pos;
    ...
    private ServerboundSetCommandBlockPacket(FriendlyByteBuf buf) {
