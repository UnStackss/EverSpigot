...
public class GameProfileArgument implements ArgumentType<GameProfileArgument.Result> {
    ...
    private static GameProfileArgument.Result parse(StringReader reader, boolean allowAtSelectors) throws CommandSyntaxException {
    ...
    public <S> CompletableFuture<Suggestions> listSuggestions(CommandContext<S> commandContext, SuggestionsBuilder suggestionsBuilder) {
        if (commandContext.getSource() instanceof SharedSuggestionProvider sharedSuggestionProvider) {
            ...
            return entitySelectorParser.fillSuggestions(
                suggestionsBuilder, builder -> SharedSuggestionProvider.suggest(sharedSuggestionProvider.getOnlinePlayerNames(), builder)
            );
        } else {
