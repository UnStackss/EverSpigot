...
public class ComponentArgument implements ArgumentType<Component> {
    ...
    public static final DynamicCommandExceptionType ERROR_INVALID_JSON = new DynamicCommandExceptionType(
        text -> Component.translatableEscape("argument.component.invalid", text)
    );
    private final HolderLookup.Provider registries;

    private ComponentArgument(HolderLookup.Provider registryLookup) {
    ...
    public static ComponentArgument textComponent(CommandBuildContext registryAccess) {
        return new ComponentArgument(registryAccess);
    }
