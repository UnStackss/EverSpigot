...
public class WorldCoordinates implements Coordinates {
    ...
    public boolean equals(Object object) {
        return this == object
            || object instanceof WorldCoordinates worldCoordinates
    ...
    public static WorldCoordinates absolute(Vec2 vec) {
        return new WorldCoordinates(new WorldCoordinate(false, (double)vec.x), new WorldCoordinate(false, (double)vec.y), new WorldCoordinate(true, 0.0));
    }
