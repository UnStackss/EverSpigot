...
public class CommonLinks {
    ...
    public static String extendRealms(String subscriptionId, UUID uuid, boolean trial) {
        return extendRealms(subscriptionId, uuid) + "&ref=" + (trial ? "expiredTrial" : "expiredRealm");
    }

    public static String extendRealms(String subscriptionId, UUID uuid) {
