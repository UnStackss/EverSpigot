    ...
    public static ModCheck identify(String vanillaBrand, Supplier<String> brandSupplier, String environment, Class<?> clazz) {
        ...
        if (!vanillaBrand.equals(string)) {
            ...
            return clazz.getSigners() == null
                ? new ModCheck(ModCheck.Confidence.VERY_LIKELY, environment + " jar signature invalidated")
                : new ModCheck(ModCheck.Confidence.PROBABLY_NOT, environment + " jar signature and brand is untouched");
        }
    }
