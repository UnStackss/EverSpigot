                                ...
                                ImmutableMap.of(
                                    ...
                                    () -> DSL.optionalFields(
                                            ...
                                            DSL.optionalFields(
                                                ...
                                                "layers",
                                                DSL.list(DSL.optionalFields("block", References.BLOCK_NAME.in(schema)))
                                            )
                                        ),
                                    "minecraft:noise",
                                    () -> DSL.optionalFields(
                                            ...
                                            DSL.or(
                                                ...
                                                DSL.optionalFields(
                                                    "default_block", References.BLOCK_NAME.in(schema), "default_fluid", References.BLOCK_NAME.in(schema)
                                                )
                                            )
                                        )
                                )
