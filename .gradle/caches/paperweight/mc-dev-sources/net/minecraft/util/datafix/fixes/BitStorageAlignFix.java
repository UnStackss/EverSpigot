...
public class BitStorageAlignFix extends DataFix {
    ...
    protected TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped(
            ...
            chunk -> chunk.updateTyped(opticFinder, level -> this.updateHeightmaps(updateSections(opticFinder2, opticFinder3, opticFinder4, level)))
        );
    }
        ...
        return fixedLevel.update(
            ...
            levelDynamic -> levelDynamic.update(
                    ...
                    heightmapsDynamic -> heightmapsDynamic.updateMapValues(
                            heightmap -> heightmap.mapSecond(heightmapDynamic -> updateBitStorage(levelDynamic, (Dynamic<?>)heightmapDynamic, 256, 9))
                        )
                )
        );
    }
                        ...
                        return i != 0 && !Mth.isPowerOfTwo(i)
                            ? section.update(
                                ...
                                sectionDynamic -> sectionDynamic.update(
                                        "BlockStates", statesDynamic -> updateBitStorage(sectionDynamic, statesDynamic, 4096, i)
                                    )
                            )
                            : section;
                    }
