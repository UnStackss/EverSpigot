...
public class ItemStackSpawnEggFix extends DataFix {
    ...
    public ItemStackSpawnEggFix(Schema outputSchema, boolean changesType, String spawnEggId) {
        super(outputSchema, changesType);
        this.itemType = spawnEggId;
    }
        ...
        return this.fixTypeEverywhereTyped("ItemInstanceSpawnEggFix" + this.getOutputSchema().getVersionKey(), type, stack -> {
            ...
            if (optional.isPresent() && Objects.equals(optional.get().getSecond(), this.itemType)) {
                ...
                if (optional2.isPresent()) {
                    return stack.set(opticFinder, Pair.of(References.ITEM_NAME.typeName(), MAP.getOrDefault(optional2.get(), "minecraft:pig_spawn_egg")));
                }
            }
