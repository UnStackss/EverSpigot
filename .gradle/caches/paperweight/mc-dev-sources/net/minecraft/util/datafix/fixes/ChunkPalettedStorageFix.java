...
public class ChunkPalettedStorageFix extends DataFix {
    ...
    private static void mapDoor(Map<String, Dynamic<?>> out, String name, int firstStateId) {
        out.put(
            ...
            BlockStateData.parse("{Name:'minecraft:" + name + "',Properties:{facing:'east',half:'lower',hinge:'left',open:'false',powered:'false'}}")
        );
        out.put(
            "minecraft:" + name + "eastlowerleftfalsetrue",
            BlockStateData.parse("{Name:'minecraft:" + name + "',Properties:{facing:'east',half:'lower',hinge:'left',open:'false',powered:'true'}}")
        );
        out.put(
            "minecraft:" + name + "eastlowerlefttruefalse",
            BlockStateData.parse("{Name:'minecraft:" + name + "',Properties:{facing:'east',half:'lower',hinge:'left',open:'true',powered:'false'}}")
        );
        out.put(
            "minecraft:" + name + "eastlowerlefttruetrue",
            BlockStateData.parse("{Name:'minecraft:" + name + "',Properties:{facing:'east',half:'lower',hinge:'left',open:'true',powered:'true'}}")
        );
        out.put("minecraft:" + name + "eastlowerrightfalsefalse", BlockStateData.getTag(firstStateId));
        out.put(
            "minecraft:" + name + "eastlowerrightfalsetrue",
            BlockStateData.parse("{Name:'minecraft:" + name + "',Properties:{facing:'east',half:'lower',hinge:'right',open:'false',powered:'true'}}")
        );
        out.put("minecraft:" + name + "eastlowerrighttruefalse", BlockStateData.getTag(firstStateId + 4));
        out.put(
            "minecraft:" + name + "eastlowerrighttruetrue",
            BlockStateData.parse("{Name:'minecraft:" + name + "',Properties:{facing:'east',half:'lower',hinge:'right',open:'true',powered:'true'}}")
        );
        ...
        out.put(
            ...
            BlockStateData.parse("{Name:'minecraft:" + name + "',Properties:{facing:'east',half:'upper',hinge:'left',open:'true',powered:'false'}}")
        );
        out.put(
            "minecraft:" + name + "eastupperlefttruetrue",
            BlockStateData.parse("{Name:'minecraft:" + name + "',Properties:{facing:'east',half:'upper',hinge:'left',open:'true',powered:'true'}}")
        );
        ...
        out.put(
            ...
            BlockStateData.parse("{Name:'minecraft:" + name + "',Properties:{facing:'east',half:'upper',hinge:'right',open:'true',powered:'false'}}")
        );
        out.put(
            "minecraft:" + name + "eastupperrighttruetrue",
            BlockStateData.parse("{Name:'minecraft:" + name + "',Properties:{facing:'east',half:'upper',hinge:'right',open:'true',powered:'true'}}")
        );
        out.put(
            "minecraft:" + name + "northlowerleftfalsefalse",
            BlockStateData.parse("{Name:'minecraft:" + name + "',Properties:{facing:'north',half:'lower',hinge:'left',open:'false',powered:'false'}}")
        );
        out.put(
            "minecraft:" + name + "northlowerleftfalsetrue",
            BlockStateData.parse("{Name:'minecraft:" + name + "',Properties:{facing:'north',half:'lower',hinge:'left',open:'false',powered:'true'}}")
        );
        out.put(
            "minecraft:" + name + "northlowerlefttruefalse",
            BlockStateData.parse("{Name:'minecraft:" + name + "',Properties:{facing:'north',half:'lower',hinge:'left',open:'true',powered:'false'}}")
        );
        out.put(
            "minecraft:" + name + "northlowerlefttruetrue",
            BlockStateData.parse("{Name:'minecraft:" + name + "',Properties:{facing:'north',half:'lower',hinge:'left',open:'true',powered:'true'}}")
        );
        ...
        out.put(
            ...
            BlockStateData.parse("{Name:'minecraft:" + name + "',Properties:{facing:'north',half:'lower',hinge:'right',open:'false',powered:'true'}}")
        );
        ...
        out.put(
            ...
            BlockStateData.parse("{Name:'minecraft:" + name + "',Properties:{facing:'north',half:'lower',hinge:'right',open:'true',powered:'true'}}")
        );
        out.put(
            "minecraft:" + name + "northupperleftfalsefalse",
            BlockStateData.parse("{Name:'minecraft:" + name + "',Properties:{facing:'north',half:'upper',hinge:'left',open:'false',powered:'false'}}")
        );
        out.put(
            "minecraft:" + name + "northupperleftfalsetrue",
            BlockStateData.parse("{Name:'minecraft:" + name + "',Properties:{facing:'north',half:'upper',hinge:'left',open:'false',powered:'true'}}")
        );
        out.put(
            "minecraft:" + name + "northupperlefttruefalse",
            BlockStateData.parse("{Name:'minecraft:" + name + "',Properties:{facing:'north',half:'upper',hinge:'left',open:'true',powered:'false'}}")
        );
        out.put(
            "minecraft:" + name + "northupperlefttruetrue",
            BlockStateData.parse("{Name:'minecraft:" + name + "',Properties:{facing:'north',half:'upper',hinge:'left',open:'true',powered:'true'}}")
        );
        out.put(
            "minecraft:" + name + "northupperrightfalsefalse",
            BlockStateData.parse("{Name:'minecraft:" + name + "',Properties:{facing:'north',half:'upper',hinge:'right',open:'false',powered:'false'}}")
        );
        out.put(
            "minecraft:" + name + "northupperrightfalsetrue",
            BlockStateData.parse("{Name:'minecraft:" + name + "',Properties:{facing:'north',half:'upper',hinge:'right',open:'false',powered:'true'}}")
        );
        out.put(
            "minecraft:" + name + "northupperrighttruefalse",
            BlockStateData.parse("{Name:'minecraft:" + name + "',Properties:{facing:'north',half:'upper',hinge:'right',open:'true',powered:'false'}}")
        );
        out.put(
            "minecraft:" + name + "northupperrighttruetrue",
            BlockStateData.parse("{Name:'minecraft:" + name + "',Properties:{facing:'north',half:'upper',hinge:'right',open:'true',powered:'true'}}")
        );
        out.put(
            "minecraft:" + name + "southlowerleftfalsefalse",
            BlockStateData.parse("{Name:'minecraft:" + name + "',Properties:{facing:'south',half:'lower',hinge:'left',open:'false',powered:'false'}}")
        );
        out.put(
            "minecraft:" + name + "southlowerleftfalsetrue",
            BlockStateData.parse("{Name:'minecraft:" + name + "',Properties:{facing:'south',half:'lower',hinge:'left',open:'false',powered:'true'}}")
        );
        out.put(
            "minecraft:" + name + "southlowerlefttruefalse",
            BlockStateData.parse("{Name:'minecraft:" + name + "',Properties:{facing:'south',half:'lower',hinge:'left',open:'true',powered:'false'}}")
        );
        out.put(
            "minecraft:" + name + "southlowerlefttruetrue",
            BlockStateData.parse("{Name:'minecraft:" + name + "',Properties:{facing:'south',half:'lower',hinge:'left',open:'true',powered:'true'}}")
        );
        ...
        out.put(
            ...
            BlockStateData.parse("{Name:'minecraft:" + name + "',Properties:{facing:'south',half:'lower',hinge:'right',open:'false',powered:'true'}}")
        );
        ...
        out.put(
            ...
            BlockStateData.parse("{Name:'minecraft:" + name + "',Properties:{facing:'south',half:'lower',hinge:'right',open:'true',powered:'true'}}")
        );
        out.put(
            "minecraft:" + name + "southupperleftfalsefalse",
            BlockStateData.parse("{Name:'minecraft:" + name + "',Properties:{facing:'south',half:'upper',hinge:'left',open:'false',powered:'false'}}")
        );
        out.put(
            "minecraft:" + name + "southupperleftfalsetrue",
            BlockStateData.parse("{Name:'minecraft:" + name + "',Properties:{facing:'south',half:'upper',hinge:'left',open:'false',powered:'true'}}")
        );
        out.put(
            "minecraft:" + name + "southupperlefttruefalse",
            BlockStateData.parse("{Name:'minecraft:" + name + "',Properties:{facing:'south',half:'upper',hinge:'left',open:'true',powered:'false'}}")
        );
        out.put(
            "minecraft:" + name + "southupperlefttruetrue",
            BlockStateData.parse("{Name:'minecraft:" + name + "',Properties:{facing:'south',half:'upper',hinge:'left',open:'true',powered:'true'}}")
        );
        out.put(
            "minecraft:" + name + "southupperrightfalsefalse",
            BlockStateData.parse("{Name:'minecraft:" + name + "',Properties:{facing:'south',half:'upper',hinge:'right',open:'false',powered:'false'}}")
        );
        out.put(
            "minecraft:" + name + "southupperrightfalsetrue",
            BlockStateData.parse("{Name:'minecraft:" + name + "',Properties:{facing:'south',half:'upper',hinge:'right',open:'false',powered:'true'}}")
        );
        out.put(
            "minecraft:" + name + "southupperrighttruefalse",
            BlockStateData.parse("{Name:'minecraft:" + name + "',Properties:{facing:'south',half:'upper',hinge:'right',open:'true',powered:'false'}}")
        );
        out.put(
            "minecraft:" + name + "southupperrighttruetrue",
            BlockStateData.parse("{Name:'minecraft:" + name + "',Properties:{facing:'south',half:'upper',hinge:'right',open:'true',powered:'true'}}")
        );
        out.put(
            "minecraft:" + name + "westlowerleftfalsefalse",
            BlockStateData.parse("{Name:'minecraft:" + name + "',Properties:{facing:'west',half:'lower',hinge:'left',open:'false',powered:'false'}}")
        );
        out.put(
            "minecraft:" + name + "westlowerleftfalsetrue",
            BlockStateData.parse("{Name:'minecraft:" + name + "',Properties:{facing:'west',half:'lower',hinge:'left',open:'false',powered:'true'}}")
        );
        out.put(
            "minecraft:" + name + "westlowerlefttruefalse",
            BlockStateData.parse("{Name:'minecraft:" + name + "',Properties:{facing:'west',half:'lower',hinge:'left',open:'true',powered:'false'}}")
        );
        out.put(
            "minecraft:" + name + "westlowerlefttruetrue",
            BlockStateData.parse("{Name:'minecraft:" + name + "',Properties:{facing:'west',half:'lower',hinge:'left',open:'true',powered:'true'}}")
        );
        ...
        out.put(
            ...
            BlockStateData.parse("{Name:'minecraft:" + name + "',Properties:{facing:'west',half:'lower',hinge:'right',open:'false',powered:'true'}}")
        );
        out.put("minecraft:" + name + "westlowerrighttruefalse", BlockStateData.getTag(firstStateId + 6));
        out.put(
            "minecraft:" + name + "westlowerrighttruetrue",
            BlockStateData.parse("{Name:'minecraft:" + name + "',Properties:{facing:'west',half:'lower',hinge:'right',open:'true',powered:'true'}}")
        );
        out.put(
            "minecraft:" + name + "westupperleftfalsefalse",
            BlockStateData.parse("{Name:'minecraft:" + name + "',Properties:{facing:'west',half:'upper',hinge:'left',open:'false',powered:'false'}}")
        );
        out.put(
            "minecraft:" + name + "westupperleftfalsetrue",
            BlockStateData.parse("{Name:'minecraft:" + name + "',Properties:{facing:'west',half:'upper',hinge:'left',open:'false',powered:'true'}}")
        );
        out.put(
            "minecraft:" + name + "westupperlefttruefalse",
            BlockStateData.parse("{Name:'minecraft:" + name + "',Properties:{facing:'west',half:'upper',hinge:'left',open:'true',powered:'false'}}")
        );
        out.put(
            "minecraft:" + name + "westupperlefttruetrue",
            BlockStateData.parse("{Name:'minecraft:" + name + "',Properties:{facing:'west',half:'upper',hinge:'left',open:'true',powered:'true'}}")
        );
        out.put(
            "minecraft:" + name + "westupperrightfalsefalse",
            BlockStateData.parse("{Name:'minecraft:" + name + "',Properties:{facing:'west',half:'upper',hinge:'right',open:'false',powered:'false'}}")
        );
        out.put(
            "minecraft:" + name + "westupperrightfalsetrue",
            BlockStateData.parse("{Name:'minecraft:" + name + "',Properties:{facing:'west',half:'upper',hinge:'right',open:'false',powered:'true'}}")
        );
        out.put(
            "minecraft:" + name + "westupperrighttruefalse",
            BlockStateData.parse("{Name:'minecraft:" + name + "',Properties:{facing:'west',half:'upper',hinge:'right',open:'true',powered:'false'}}")
        );
        out.put(
            "minecraft:" + name + "westupperrighttruetrue",
            BlockStateData.parse("{Name:'minecraft:" + name + "',Properties:{facing:'west',half:'upper',hinge:'right',open:'true',powered:'true'}}")
        );
    }

    private static void addBeds(Map<String, Dynamic<?>> out, int colorId, String color) {
        out.put(
            "southfalsefoot" + colorId, BlockStateData.parse("{Name:'minecraft:" + color + "_bed',Properties:{facing:'south',occupied:'false',part:'foot'}}")
        );
        ...
        out.put(
            "northfalsefoot" + colorId, BlockStateData.parse("{Name:'minecraft:" + color + "_bed',Properties:{facing:'north',occupied:'false',part:'foot'}}")
        );
        ...
        out.put(
            "southfalsehead" + colorId, BlockStateData.parse("{Name:'minecraft:" + color + "_bed',Properties:{facing:'south',occupied:'false',part:'head'}}")
        );
        ...
        out.put(
            "northfalsehead" + colorId, BlockStateData.parse("{Name:'minecraft:" + color + "_bed',Properties:{facing:'north',occupied:'false',part:'head'}}")
        );
    ...
    private Dynamic<?> fix(Dynamic<?> chunkDynamic) {
        ...
        return optional.isPresent() && optional.get().get("Sections").asStreamOpt().result().isPresent()
            ? chunkDynamic.set("Level", new ChunkPalettedStorageFix.UpgradeChunk((Dynamic<?>)optional.get()).write())
            : chunkDynamic;
    }
    ...
    public static enum Direction {
        ...
        private Direction(final ChunkPalettedStorageFix.Direction.AxisDirection direction, final ChunkPalettedStorageFix.Direction.Axis axis) {
            this.axis = axis;
    ...
    static class Section {
        ...
        public int upgrade(int sidesToUpgrade) {
            if (!this.hasData) {
                ...
                ChunkPalettedStorageFix.DataLayer dataLayer2 = this.section
                    .get("Add")
                    .asByteBufferOpt()
                    .map(byteBufferx -> new ChunkPalettedStorageFix.DataLayer(DataFixUtils.toArray(byteBufferx)))
                    .result()
    ...
    static final class UpgradeChunk {
                            ...
                            blockEntityTag -> {
                                ...
                                if (this.blockEntities.put(l, (Dynamic<?>)blockEntityTag) != null) {
                                    ChunkPalettedStorageFix.LOGGER
                                        .warn("In chunk: {}x{} found a duplicate block entity at position: [{}, {}, {}]", this.x, this.z, ix, j, k);
                                }
                            }
                        )
                );
                        ...
                        switch (entry.getKey()) {
                            ...
                            case 25:
                                for (int m : entry.getValue()) {
                                    m |= i;
                                    Dynamic<?> dynamic4 = this.removeBlockEntity(m);
                                    if (dynamic4 != null) {
                                        String string4 = Boolean.toString(dynamic4.get("powered").asBoolean(false))
                                            + (byte)Math.min(Math.max(dynamic4.get("note").asInt(0), 0), 24);
                                        this.setBlock(
                                            m,
                                            ChunkPalettedStorageFix.NOTE_BLOCK_MAP.getOrDefault(string4, ChunkPalettedStorageFix.NOTE_BLOCK_MAP.get("false0"))
                                        );
                                    }
                                }
                                break;
                            case 26:
                                for (int n : entry.getValue()) {
                                    n |= i;
                                    Dynamic<?> dynamic5 = this.getBlockEntity(n);
                                    Dynamic<?> dynamic6 = this.getBlock(n);
                                    if (dynamic5 != null) {
                                        int o = dynamic5.get("color").asInt(0);
                                        if (o != 14 && o >= 0 && o < 16) {
                                            String string5 = ChunkPalettedStorageFix.getProperty(dynamic6, "facing")
                                                + ChunkPalettedStorageFix.getProperty(dynamic6, "occupied")
                                                + ChunkPalettedStorageFix.getProperty(dynamic6, "part")
                                                + o;
                            ...
                            case 197:
                                for (int u : entry.getValue()) {
                                    u |= i;
                                    Dynamic<?> dynamic12 = this.getBlock(u);
                                    if (ChunkPalettedStorageFix.getName(dynamic12).endsWith("_door")) {
                                        ...
                                        if ("lower".equals(ChunkPalettedStorageFix.getProperty(dynamic13, "half"))) {
                                            ...
                                            if (string13.equals(ChunkPalettedStorageFix.getName(dynamic14))) {
                                                ...
                                                this.setBlock(
                                                    u, ChunkPalettedStorageFix.DOOR_MAP.get(string13 + string14 + "lower" + string16 + string15 + string17)
                                                );
                                                this.setBlock(
                                                    v, ChunkPalettedStorageFix.DOOR_MAP.get(string13 + string14 + "upper" + string16 + string15 + string17)
                                                );
                                            }
                                        }
                                    }
                            ...
                            case 86:
                                for (int r : entry.getValue()) {
                                    r |= i;
                                    Dynamic<?> dynamic9 = this.getBlock(r);
                            ...
                            case 140:
                                for (int s : entry.getValue()) {
                                    s |= i;
                                    Dynamic<?> dynamic10 = this.removeBlockEntity(s);
                                    if (dynamic10 != null) {
                                        String string8 = dynamic10.get("Item").asString("") + dynamic10.get("Data").asInt(0);
                                        this.setBlock(
                                            s,
                                            ChunkPalettedStorageFix.FLOWER_POT_MAP
                                                .getOrDefault(string8, ChunkPalettedStorageFix.FLOWER_POT_MAP.get("minecraft:air0"))
                                        );
                                    }
                                }
                                break;
                            case 144:
                                for (int t : entry.getValue()) {
                                    t |= i;
                                    Dynamic<?> dynamic11 = this.getBlockEntity(t);
                                    if (dynamic11 != null) {
                                        ...
                                        if (!"up".equals(string10) && !"down".equals(string10)) {
                                            ...
                                            string12 = string9 + dynamic11.get("Rot").asInt(0);
                                        }
                                        ...
                                        this.setBlock(
                                            t, ChunkPalettedStorageFix.SKULL_MAP.getOrDefault(string12, ChunkPalettedStorageFix.SKULL_MAP.get("0north"))
                                        );
                                    }
                                }
                                break;
                            case 175:
                                for (int w : entry.getValue()) {
                                    w |= i;
                                    Dynamic<?> dynamic15 = this.getBlock(w);
                                    if ("upper".equals(ChunkPalettedStorageFix.getProperty(dynamic15, "half"))) {
                                        Dynamic<?> dynamic16 = this.getBlock(relative(w, ChunkPalettedStorageFix.Direction.DOWN));
                            ...
                            case 177:
                                for (int p : entry.getValue()) {
                                    p |= i;
                                    Dynamic<?> dynamic7 = this.getBlockEntity(p);
                                    Dynamic<?> dynamic8 = this.getBlock(p);
                                    if (dynamic7 != null) {
                                        int q = dynamic7.get("Base").asInt(0);
                                        if (q != 15 && q >= 0 && q < 16) {
                                            String string6 = ChunkPalettedStorageFix.getProperty(dynamic8, entry.getKey() == 176 ? "rotation" : "facing")
                                                + "_"
                                                + q;
        ...
        public static int relative(int packedLocalPos, ChunkPalettedStorageFix.Direction direction) {
            switch (direction.getAxis()) {
                case X:
                    int i = (packedLocalPos & 15) + direction.getAxisDirection().getStep();
                ...
                case Z:
                    int k = (packedLocalPos >> 4 & 15) + direction.getAxisDirection().getStep();
