...
public class EntityItemFrameDirectionFix extends NamedEntityFix {
    ...
    public Dynamic<?> fixTag(Dynamic<?> itemFrameDynamic) {
        return itemFrameDynamic.set("Facing", itemFrameDynamic.createByte(direction2dTo3d(itemFrameDynamic.get("Facing").asByte((byte)0))));
    }
    ...
    private static byte direction2dTo3d(byte oldDirection) {
        switch (oldDirection) {
            case 0:
                return 3;
            case 1:
