...
public class EntityBlockStateFix extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        ...
        Function<Typed<?>, Typed<?>> function = minecart -> this.updateBlockToBlockState(minecart, "DisplayTile", "DisplayData", "DisplayState");
        Function<Typed<?>, Typed<?>> function2 = arrow -> this.updateBlockToBlockState(arrow, "inTile", "inData", "inBlockState");
        ...
        return this.fixTypeEverywhereTyped(
            ...
            schema2.getType(References.ENTITY),
            entity -> {
                entity = this.updateEntity(entity, "minecraft:falling_block", this::updateFallingBlock);
                entity = this.updateEntity(
                    entity, "minecraft:enderman", enderman -> this.updateBlockToBlockState(enderman, "carried", "carriedData", "carriedBlockState")
                );
                entity = this.updateEntity(entity, "minecraft:arrow", function2);
                entity = this.updateEntity(entity, "minecraft:spectral_arrow", function2);
                entity = this.updateEntity(entity, "minecraft:egg", function3);
                entity = this.updateEntity(entity, "minecraft:ender_pearl", function3);
                entity = this.updateEntity(entity, "minecraft:fireball", function3);
                entity = this.updateEntity(entity, "minecraft:potion", function3);
                entity = this.updateEntity(entity, "minecraft:small_fireball", function3);
                entity = this.updateEntity(entity, "minecraft:snowball", function3);
                entity = this.updateEntity(entity, "minecraft:wither_skull", function3);
                entity = this.updateEntity(entity, "minecraft:xp_bottle", function3);
                entity = this.updateEntity(entity, "minecraft:commandblock_minecart", function);
                entity = this.updateEntity(entity, "minecraft:minecart", function);
                entity = this.updateEntity(entity, "minecraft:chest_minecart", function);
                entity = this.updateEntity(entity, "minecraft:furnace_minecart", function);
                entity = this.updateEntity(entity, "minecraft:tnt_minecart", function);
                entity = this.updateEntity(entity, "minecraft:hopper_minecart", function);
                return this.updateEntity(entity, "minecraft:spawner_minecart", function);
            }
        );
    }
    ...
    private Typed<?> updateFallingBlock(Typed<?> fallingBlock) {
        ...
        return fallingBlock.update(type.finder(), type2, state -> {
            int i = state.map(pair -> pair.getSecond().map(id -> (Integer)id, EntityBlockStateFix::getBlockId), unit -> {
    ...
    private Typed<?> updateBlockToBlockState(Typed<?> entity, String oldIdKey, String oldDataKey, String newStateKey) {
        Type<Pair<String, Either<Integer, String>>> type = DSL.field(
            oldIdKey, DSL.named(References.BLOCK_NAME.typeName(), DSL.or(DSL.intType(), NamespacedSchema.namespacedString()))
        );
        ...
        return entity.update(type.finder(), type2, state -> {
            int i = state.getSecond().map(id -> (Integer)id, EntityBlockStateFix::getBlockId);
    ...
    private Typed<?> updateEntity(Typed<?> entity, String entityId, Function<Typed<?>, Typed<?>> function) {
