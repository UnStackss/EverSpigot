    ...
    protected TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped(
            ...
            worldGenSettingsTyped -> {
                ...
                return worldGenSettingsTyped.update(
                        DSL.remainderFinder(), worldGenSettingsDynamic -> worldGenSettingsDynamic.remove("has_increased_height_already")
                    )
                    .updateTyped(
                        opticFinder,
                        type3,
                                                    ...
                                                    if ("minecraft:noise".equals(string)) {
                                                        ...
                                                        overworldGeneratorDynamic = overworldGeneratorDynamic.update(
                                                            ...
                                                            overworldBiomeSourceDynamic -> {
                                                                ...
                                                                if ("minecraft:vanilla_layered".equals(stringx)
                                                                    || bl && "minecraft:multi_noise".equals(stringx)) {
                                                        ...
                                                        return mutableBoolean.booleanValue()
                                                            ? overworldGeneratorDynamic.update(
                                                                "settings",
                                                                overworldGeneratorSettingsDynamic -> "minecraft:overworld"
                                                                            .equals(overworldGeneratorSettingsDynamic.asString(""))
                                                        ...
                                                        return bl2
                                                            ...
                                                            : overworldGeneratorDynamic.update(
                                                                "settings",
                                                                overworldGeneratorSettingsDynamic -> overworldGeneratorSettingsDynamic.update(
                                                                        "layers", WorldGenSettingsHeightAndBiomeFix::updateLayers
                                                                    )
                                                            );
                                                    } else {
