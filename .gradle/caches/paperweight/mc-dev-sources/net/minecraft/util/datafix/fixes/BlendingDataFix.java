...
public class BlendingDataFix extends DataFix {
    ...
    protected TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped(
            this.name, type, typed -> typed.update(DSL.remainderFinder(), chunk -> updateChunkTag(chunk, chunk.get("__context")))
        );
    }
        ...
        return dynamic.set(
            ...
            dynamic.createMap(
                Map.of(
                    ...
                    dynamic.createInt(SectionPos.blockToSectionCoord(minY)),
                    dynamic.createString("max_section"),
                    dynamic.createInt(SectionPos.blockToSectionCoord(minY + height))
                )
            )
        );
    }
