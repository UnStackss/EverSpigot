...
public interface JvmProfiler {
    ...
    void onPacketReceived(ConnectionProtocol state, PacketType<?> type, SocketAddress remoteAddress, int bytes);

    void onPacketSent(ConnectionProtocol state, PacketType<?> type, SocketAddress remoteAddress, int bytes);

    void onRegionFileRead(RegionStorageInfo key, ChunkPos chunkPos, RegionFileVersion format, int bytes);

    void onRegionFileWrite(RegionStorageInfo key, ChunkPos chunkPos, RegionFileVersion format, int bytes);
