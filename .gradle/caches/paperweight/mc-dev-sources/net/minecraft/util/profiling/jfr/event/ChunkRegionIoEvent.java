...
public abstract class ChunkRegionIoEvent extends Event {
    ...
    public ChunkRegionIoEvent(RegionStorageInfo key, ChunkPos chunkPos, RegionFileVersion format, int bytes) {
        ...
        this.levelId = key.level();
        this.dimension = key.dimension().location().toString();
        this.type = key.type();
