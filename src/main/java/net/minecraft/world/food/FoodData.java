...
public class FoodData {
    ...
    public void eat(ItemStack itemstack, FoodProperties foodinfo) {
        ...
        org.bukkit.event.entity.FoodLevelChangeEvent event = org.bukkit.craftbukkit.event.CraftEventFactory.callFoodLevelChangeEvent(this.entityhuman, foodinfo.nutrition() + oldFoodLevel, itemstack);
