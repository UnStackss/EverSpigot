...
public abstract class World implements GeneratorAccess, AutoCloseable {
    ...
    public void playSound(@Nullable EntityHuman entityhuman, double d0, double d1, double d2, Holder<SoundEffect> holder, SoundCategory soundcategory, float f, float f1) {
        this.playSeededSound(entityhuman, d0, d1, d2, holder, soundcategory, f, f1, this.threadSafeRandom.nextLong());
    }
