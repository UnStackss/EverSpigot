...
public class DataFixers {
    ...
    private static void addFixers(DataFixerBuilder builder) {
        ...
        Schema schema199 = builder.addSchema(3800, DataFixers.SAME_NAMESPACED);
        ...
        Schema schema200 = builder.addSchema(3803, DataFixers.SAME_NAMESPACED);
        ...
        Schema schema202 = builder.addSchema(3807, 1, DataFixers.SAME_NAMESPACED);
        ...
        Schema schema206 = builder.addSchema(3809, DataFixers.SAME_NAMESPACED);

        builder.addFixer(new ChestedHorsesInventoryZeroIndexingFix(schema206));
        Schema schema207 = builder.addSchema(3812, DataFixers.SAME_NAMESPACED);

        builder.addFixer(new FixWolfHealth(schema207));
        Schema schema208 = builder.addSchema(3813, DataFixers.SAME_NAMESPACED);

        builder.addFixer(new BlockPosFormatAndRenamesFix(schema208));
        Schema schema209 = builder.addSchema(3814, DataFixers.SAME_NAMESPACED);

        builder.addFixer(new AttributesRename(schema209, "Rename jump strength attribute", DataFixers.createRenamer("minecraft:horse.jump_strength", "minecraft:generic.jump_strength")));
        ...
        Schema schema212 = builder.addSchema(3818, 1, DataFixers.SAME_NAMESPACED);

        builder.addFixer(new BannerPatternFormatFix(schema212));
        Schema schema213 = builder.addSchema(3818, 2, DataFixers.SAME_NAMESPACED);
        ...
        Schema schema217 = builder.addSchema(3818, 6, DataFixers.SAME_NAMESPACED);

        builder.addFixer(new AreaEffectCloudPotionFix(schema217));
        Schema schema218 = builder.addSchema(3820, DataFixers.SAME_NAMESPACED);
        ...
        Schema schema220 = builder.addSchema(3828, DataFixers.SAME_NAMESPACED);

        builder.addFixer(new EmptyItemInVillagerTradeFix(schema220));
        Schema schema221 = builder.addSchema(3833, DataFixers.SAME_NAMESPACED);
        ...
        Schema schema223 = builder.addSchema(3939, DataFixers.SAME_NAMESPACED);

        builder.addFixer(new FeatureFlagRemoveFix(schema223, "Remove 1.21 feature toggle", Set.of("minecraft:update_1_21")));
        Schema schema224 = builder.addSchema(3943, DataFixers.SAME_NAMESPACED);

        builder.addFixer(new OptionsMenuBlurrinessFix(schema224));
        Schema schema225 = builder.addSchema(3945, DataFixers.SAME_NAMESPACED);
