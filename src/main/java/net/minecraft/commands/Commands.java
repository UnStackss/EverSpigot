...
import net.minecraft.server.commands.TerminateCommand;
import net.minecraft.server.commands.UnGrantCommands;
...
import net.minecraft.server.commands.GrantCommand;
...
public class Commands {
    ...
    public Commands(Commands.CommandSelection environment, CommandBuildContext commandRegistryAccess) {
        ...
        if (environment.includeDedicated) {
            ...
            UnGrantCommands.register(this.dispatcher);
            GrantCommand.register(this.dispatcher);
            ...
            TerminateCommand.register(this.dispatcher);
