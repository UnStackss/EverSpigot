...
public class PatternTypeTest extends AbstractTestingBase {
    ...
    public void testToBukkit() {
        for (BannerPattern nms : MinecraftServer.getDefaultRegistryAccess().registryOrThrow(Registries.BANNER_PATTERN)) {
    ...
    public void testToNMS() {
        net.minecraft.core.Registry<BannerPattern> registry = MinecraftServer.getDefaultRegistryAccess().registryOrThrow(Registries.BANNER_PATTERN);
